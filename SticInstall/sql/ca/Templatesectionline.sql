-- SinergiaCRM: Seccions de plantilles d'exemple

REPLACE INTO templatesectionline VALUES ('00000caa-7105-eef5-ad4a-68a414181198', 'Exemple 01 - Imatge de capçalera', UTC_TIMESTAMP(), UTC_TIMESTAMP(), '1', '1', '
...
REPLACE INTO templatesectionline VALUES ('00000946-dbcc-c8ba-9c16-68a41426bf4e', 'Exemple 02 - Logo', UTC_TIMESTAMP(), UTC_TIMESTAMP(), '1', '1', '
<table style="background-color:#FFFFFF;" width="100%">
    <tbody>
        <tr>
...
REPLACE INTO templatesectionline VALUES ('00000050-98e6-6f0d-04c0-68a4143f6d6c', 'Exemple 03 - Encapçalat H1', UTC_TIMESTAMP(), UTC_TIMESTAMP(), '1', '1', '
<table style="background-color:#FFFFFF;" width="100%">
    <tbody>
        <tr>
...
REPLACE INTO templatesectionline VALUES ('0000006d-a721-a6c5-9df6-68a414b67f90', 'Exemple 04 - Encapçalat H3', UTC_TIMESTAMP(), UTC_TIMESTAMP(), '1', '1', '
<table style="background-color:#FFFFFF;" width="100%">
    <tbody>
        <tr>
            <td style="padding:10px;" align="center"><h3>Capçalera H3</h3></td>
        </tr>
    </tbody>
</table>
', 0, 'custom/modules/TemplateSectionLine/sticImagesFiles/Thumbnails/04_Encabezado_H3_225px.png', '', 4, '1');

REPLACE INTO templatesectionline VALUES ('00000fbe-4fbd-9659-bd90-68a31e6c9225', 'Exemple 05 - Text', UTC_TIMESTAMP(), UTC_TIMESTAMP(), '1', '1', '
<table style="background-color:#FFFFFF;" width="100%">
    <tbody>
        <tr>
            <td style="padding:10px;" align="center">
...
REPLACE INTO templatesectionline VALUES ('000004dd-964f-9c67-1993-68a3289ad277', 'Exemple 06 - Comentari', UTC_TIMESTAMP(), UTC_TIMESTAMP(), '1', '1', '
<table style="background-color:#FFFFFF;" width="100%">
    <tbody>
        <tr>
            <td style="padding:10px;" align="center">
                <p><em>* Això és un comentari</em></p>
            </td>
        </tr>
    </tbody>
</table>
...
REPLACE INTO templatesectionline VALUES ('00000fc7-4281-5d09-45f3-68a415cd2a79', 'Exemple 07 - Avís', UTC_TIMESTAMP(), UTC_TIMESTAMP(), '1', '1', '
<table style="background-color:#FFFFFF;" width="100%">
    <tbody>
        <tr>
            <td style="padding:10px;font-weight:bold;color:#FF0000;" align="center">Això és un missatge ressaltat en color</td>
        </tr>
    </tbody>
</table>
', 0, 'custom/modules/TemplateSectionLine/sticImagesFiles/Thumbnails/07_Aviso_225px.png', '', 7, '1');

REPLACE INTO templatesectionline VALUES ('d3b49c38-eeba-b910-2590-5b4069caaac1', "Exemple 08 - Imatge a l'esquerra", UTC_TIMESTAMP(), UTC_TIMESTAMP(), '1', '1', '
...
REPLACE INTO templatesectionline VALUES ('dba65685-d26f-6ecd-802c-5b406983c9b5', 'Exemple 09 - Imatge a la dreta', UTC_TIMESTAMP(), UTC_TIMESTAMP(), '1', '1', '
<table width="100%" style="background-color:white">
    <tbody>
        <tr>
            <td align="center" style="padding:10px;">
...
REPLACE INTO templatesectionline VALUES ('52cdc554-bd90-f8f9-e2e0-66d718ae8fe9', 'Exemple 10 - Dues columnes amb imatge', UTC_TIMESTAMP(), UTC_TIMESTAMP(), '1', '1', '
<table width="100%" style="background-color:white">
    <tbody>
        <tr>
            <td style="padding:10px;text-align: center; vertical-align: middle;" align="center">
...
REPLACE INTO templatesectionline VALUES ('9f118e85-13f2-baa9-4ee3-66d80c674dea', 'Exemple 11 - Tres columnes amb imatge', UTC_TIMESTAMP(), UTC_TIMESTAMP(), '1', '1', '
<table width="100%" style="background-color:white">
    <tbody>
        <tr>
            <td style="padding:10px;text-align: center; vertical-align: middle;" align="center">
...
REPLACE INTO templatesectionline VALUES ('00000f55-0165-c6f0-d49e-68a31f58ce3f', 'Exemple 12 - Video', UTC_TIMESTAMP(), UTC_TIMESTAMP(), '1', '1', '
<table style="background-color:#FFFFFF;" width="100%">
    <tbody>
        <tr>
...
REPLACE INTO templatesectionline VALUES ('000009b2-a259-4b41-df58-68a31fdc03aa', 'Exemple 13 - Botó', UTC_TIMESTAMP(), UTC_TIMESTAMP(), '1', '1', '
<table style="background-color:#FFFFFF; width:100%;">
    <tbody>
        <tr>
            <td align="center">
...
REPLACE INTO templatesectionline VALUES ('0000021e-291a-84c6-8641-68a323ea5043', 'Exemple 14 - Separador', UTC_TIMESTAMP(), UTC_TIMESTAMP(), '1', '1', '
<br /><br />
    <hr />
<br /><br />
', 0, 'custom/modules/TemplateSectionLine/sticImagesFiles/Thumbnails/14_Separador_225px.png', '', 14, '1');

REPLACE INTO templatesectionline VALUES ('00000138-07eb-c36d-1c5f-68a325bf884c', 'Exemple 15 - Peu - Xarxes socials', UTC_TIMESTAMP(), UTC_TIMESTAMP(), '1', '1', '
<table style="background-color:#FFFFFF;" width="100%">
    <tbody>
        <tr>
            <td style="padding:10px;" align="center">
...
REPLACE INTO templatesectionline VALUES ('00000ec2-1b97-6474-0aa2-68a3254bbb85', 'Exemple 16 - Peu - Enllaç de Baixa', UTC_TIMESTAMP(), UTC_TIMESTAMP(), '1', '1', '
<table style="background-color:#FFFFFF;" width="100%">
    <tbody>
        <tr>
            <td >Si no vols rebre més informació fes clic en aquest <a href="UNSUBSCRIBE_LINK">enllaç</a> ... </td>
        </tr>
    </tbody>
</table>
