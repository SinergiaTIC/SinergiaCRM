...
$mod_strings = array(
    ...
    'LBL_DOCUMENT_INFORMATION' => 'Visió general del document', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
