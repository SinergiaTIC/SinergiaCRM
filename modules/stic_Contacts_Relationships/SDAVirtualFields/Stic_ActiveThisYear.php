 ...
 *
 * This virtual field returns 1 if the relationship is active at any point
 * during the current year, and 0 otherwise. It's designed to provide a quick
 * way to filter or identify current year active relationships in reports
 * and analyses.
 */

// Label for the virtual field (can use an existing label in the module or any string)
$virtualFieldLabel = 'LBL_SDA_ACTIVE_CURRENT_YEAR_MINUS_0';

// Description of the virtual field (can use an existing label in the module or any string)
$virtualFieldDescription = 'LBL_SDA_ACTIVE_CURRENT_YEAR_MINUS_0_DESCRIPTION';
