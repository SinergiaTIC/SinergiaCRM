...
class stic_Signature_LogViewEdit extends ViewEdit
{
    /**
     * Constructor for stic_Signature_LogViewEdit.
    ...
    public function preDisplay()
    {
        ...
        // Force redirect to DetailView 
        SugarApplication::redirect('index.php?module=stic_Signature_Log&action=DetailView&record=' . $this->bean->id);
