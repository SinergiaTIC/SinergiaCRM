...
$mod_strings = array (
  ...
  'LBL_DATABLOCK_ADD_LABEL_DESC' => 'Text that will be displayed on the form button to add another entry to this data block group.',
  'LBL_DATABLOCK_ADD_LABEL_DEFAULT' => 'Add another',
  'LBL_DATABLOCK_REMOVE_LABEL' => 'Remove button text',
  'LBL_DATABLOCK_REMOVE_LABEL_DESC' => 'Text that will be displayed on the form button to remove an entry from this data block group.',
  'LBL_DATABLOCK_REMOVE_LABEL_DEFAULT' => 'Remove',
  'LBL_DATABLOCK_ADD_TO_GROUP' => 'Add data block to group',
  ...
  'LBL_ACTION_AUTOMATIC_TITLE' => 'Automatic action',
  'LBL_ACTION_REPEATABLE_GROUP_TITLE' => 'Belongs to the repeatable group',
