...
$mod_strings = array (
  ...
  'LBL_DATABLOCK_INCLUDE_LABEL' => "Etiqueta d'inclusió",
  'LBL_DATABLOCK_INCLUDE_LABEL_DESC' => "Text que apareixarà a l'interruptor del formulari per indicar que cal incloure les dades d'aquest grup de blocs de dades.",
  'LBL_DATABLOCK_INCLUDE_LABEL_DEFAULT' => 'Inclou',
  'LBL_DATABLOCK_MAX_REPETITIONS' => 'Màxim',
  'LBL_DATABLOCK_MAX_REPETITIONS_DESC' => "Nombre màxim d'entrades d'aquest grup de blocs de dades que es poden afegir a una resposta del formulari. Deixa-ho buit per a un nombre il·limitat d'entrades.",
  'LBL_DATABLOCK_ADD_LABEL' => "Text del botó d'afegir",
  'LBL_DATABLOCK_ADD_LABEL_DESC' => "Text que es mostrarà al botó del formulari per afegir una altra entrada d'aquest grup de blocs de dades.",
  'LBL_DATABLOCK_ADD_LABEL_DEFAULT' => 'Afegeix-ne una altra',
  'LBL_DATABLOCK_REMOVE_LABEL' => "Text del botó d'eliminar",
  'LBL_DATABLOCK_REMOVE_LABEL_DESC' => "Text que es mostrarà al botó del formulari per eliminar una entrada d'aquest grup de blocs de dades.",
  'LBL_DATABLOCK_REMOVE_LABEL_DEFAULT' => 'Elimina',
  'LBL_DATABLOCK_ADD_TO_GROUP' => 'Afegeix un bloc de dades al grup',
  ...
  'LBL_ACTION_AUTOMATIC_TITLE' => 'Acció automàtica',
  ...
  'LBL_ACTION_DELETE_CONFIRM' => "Segur que vols eliminar aquesta acció?",
