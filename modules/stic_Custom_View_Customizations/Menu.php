...
if(ACLController::checkAccess('stic_Custom_View_Customizations', 'import', true)){
    $module_menu[]=array('index.php?module=Import&action=Step1&import_module=stic_Custom_View_Customizations&return_module=stic_Custom_View_Customizations&return_action=index', $app_strings['LBL_IMPORT'], 'Import', 'stic_Custom_View_Customizations');
}