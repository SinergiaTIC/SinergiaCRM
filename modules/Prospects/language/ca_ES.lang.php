...
$mod_strings = array(
    ...
    'LBL_NAME' => 'Nom:',
    'LBL_PROSPECT_INFORMATION' => 'Visió general de la perspectiva', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
