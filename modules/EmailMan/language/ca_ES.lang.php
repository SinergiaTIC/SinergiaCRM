...
$mod_strings = array(
    ...
    'LBL_IN_QUEUE_DATE' => 'Data de posada a la cua',
    ...
    'LBL_EMAIL_DEFAULT_DELETE_ATTACHMENTS' => 'Esborra els arxius adjunts i les notes relacionades dels missatges esborrats',
    ...
    'LBL_EMAIL_ENABLE_SEND_OPT_IN' => "Envia el missatge d'autorització automàticament",
    'LBL_EMAIL_CONFIRM_OPT_IN_TEMPLATE_ID' => "Plantilla de correu de confirmació de l'autorització",
    'LBL_LEGACY_EMAIL_COMPOSE_BEHAVIOR' => 'Activa el comportament antic de redacció de correu electrònic',
    ...
    'LBL_CAMP_MESSAGE_COPY' => 'Desa còpies dels missatges de la campanya:',
    'LBL_CAMP_MESSAGE_COPY_DESC' => 'Voleu desar còpies de <b>tots els missatges de correu electrònic</b> enviats en les campanyes? <b>Es recomana no fer-ho</b>. Si així ho indiqueu, només es desarà la plantilla enviada i les variables per recrear el missatge individual en comptes dels missatges sencers.',
    ...
    'LBL_MODULE_TITLE' => 'Administració de la cua de correu electrònic sortint',
    'LBL_NOTIFICATION_ON_DESC' => "Envia correus electrònics de notificació a l'assignar registres.",
    'LBL_NOTIFY_FROMADDRESS' => 'Adreça remitent:',
    'LBL_NOTIFY_FROMNAME' => 'Nom remitent:',
    'LBL_NOTIFY_ON' => 'Activar les notificacions?',
    ...
    'TRACKING_ENTRIES_LOCATION_DEFAULT_VALUE' => 'Valor a Config.php per a site_url',
    ...
    'LBL_OUTGOING_SECTION_HELP' => 'Configurar el servidor de correu sortint per defecte per enviar notificacions de correu electrònic, incloent avisos de fluxos de treball.',
    'LBL_ALLOW_DEFAULT_SELECTION' => "Els usuaris poden enviar amb la identitat d'aquest compte:",
    'LBL_ALLOW_DEFAULT_SELECTION_HELP' => 'Quan aquesta opció està activada, tots els usuaris poden enviar correus electrònics utilitzant el compte de correu sortint general. Si no ho està, els usuaris podran enviar correu quan hagin configurat el seu propi compte.',
    'LBL_FROM_ADDRESS_HELP' => "Quan està activat, el nom i l'adreça de correu electrònic de l'usuari assignat s'inclouran al camp del correu electrònic. Aquesta funció no funciona amb servidors SMTP que no permeten l'enviament d'un compte de correu electrònic diferent al compte del servidor.",
