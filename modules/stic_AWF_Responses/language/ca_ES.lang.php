...
'LBL_LIST_FORM_TITLE' => 'Llista de Respostes a formularis',
  ...
  'LNK_NEW_RECORD' => 'Crear Resposta a formulari',
  'LNK_LIST' => 'Veure Respostes a formularis',
  'LNK_IMPORT_stic_AWF_Responses' => 'Importar Respostes a formularis',
  'LBL_SEARCH_FORM_TITLE' => 'Cercar Respostes a formularis',
  ...
  'LBL_BUTTON_GO_BACK_AND_FIX' => 'Tornar a editar el formulari',
  ...
  'LBL_RESPONSE_TIMETRAP_SPAM' => "Resposta no desitjada: s'ha omplert el formulari massa ràpid.",
  ...
  'LBL_ERROR_GENERATING_HTML_SUMMARY' => 'Error generant el resum de la resposta en format taula',

  // User-facing validation errors
  'LBL_ERROR_REQUIRED_FIELD' => 'És un camp obligatori.',
  'LBL_ERROR_INTEGER_FIELD' => 'El valor ha de ser un número sencer.',
  'LBL_ERROR_NUMERIC_FIELD' => 'El valor ha de ser numèric.',
  'LBL_ERROR_DATE_FIELD' => 'El valor ha de ser una data vàlida.',
  'LBL_ERROR_BOOL_FIELD' => 'El valor ha de ser vertader o fals.',
