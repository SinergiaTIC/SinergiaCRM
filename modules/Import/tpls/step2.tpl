...
{* STIC#1086 - Show button to validate the import file *}
#fileValidation {
    color: black;
...
<br /><br />
<a id="fileValidation" name="fileValidation" class="button" style: href="?module=stic_Import_Validation&action=Step1&import_module={$IMPORT_MODULE}&return_module={$IMPORT_MODULE}&return_action=index" >{$MOD.LBL_FILE_VALIDATION_BUTTON} </a>
{* END STIC-Custom *}
