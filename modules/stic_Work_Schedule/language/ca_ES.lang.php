...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => "Llista de registres d'Horari Laboral",
   'LBL_MODULE_NAME' => 'Horari Laboral',
   'LBL_MODULE_TITLE' => 'Horari Laboral',
   'LBL_HOMEPAGE_TITLE' => 'El meu Horari Laboral',
   'LNK_NEW_RECORD' => "Crear registre d'Horari Laboral",
   'LNK_LIST' => "Veure registres d'Horari laboral",
   'LNK_IMPORT_STIC_WORK_SCHEDULE' => "Importar registres d'Horari Laboral",
   'LBL_SEARCH_FORM_TITLE' => "Cerca registres d'Horari Laboral",
   'LBL_HISTORY_SUBPANEL_TITLE' => 'Veure Historial',
   'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Activitats',
   'LBL_STIC_WORK_SCHEDULE_SUBPANEL_TITLE' => 'Horari Laboral',
   'LBL_NEW_FORM_TITLE' => "Nou registre d'Horari Laboral",
