...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'Financial products List',
  'LBL_MODULE_NAME' => 'Financial products',
  'LBL_MODULE_TITLE' => 'Financial products',
  'LBL_HOMEPAGE_TITLE' => 'My Financial products',
  'LNK_NEW_RECORD' => 'Create Financial product',
  'LNK_LIST' => 'View Financial products',
  'LNK_IMPORT_STIC_FINANCIAL_PRODUCTS' => 'Import Financial products',
  'LBL_SEARCH_FORM_TITLE' => 'Search Financial products',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'History',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Activities',
  'LBL_STIC_FINANCIAL_PRODUCTS_SUBPANEL_TITLE' => 'Financial products',
  'LBL_NEW_FORM_TITLE' => 'New Financial product',
  'LBL_ACTIVE' => 'Active',
  'LBL_IBAN' => 'IBAN',
  'LBL_START_DATE' => 'Start date',
  'LBL_INITIAL_BALANCE' => 'Initial balance',
  'LBL_CURRENT_BALANCE' => 'Current balance',
  'LBL_BALANCE_ERROR' => 'Balance error',
  'LBL_TYPE' => 'Type',
  'LBL_ENTITY' => 'Financial entity',
  'LBL_HOLDERS' => 'Holders',
  'LBL_PANEL_RECORD_DETAILS' => 'Record details',
  'LBL_INITIAL_BALANCE_INFO' => 'The initial balance can be edited as long as there are no transactions associated with the financial product. In case the first associated transaction arrives via an import from a Norma 43 file, the value will be automatically established based on the information contained in the file.',
  ...
  'LBL_ENTITY_INFO' => 'The financial entity will auto-complete based on the IBAN entered. If the IBAN is not required, the financial entity can be entered manually.',
  ...
  'LBL_IBAN_REQUIRED' => 'The IBAN is required for this type of financial product.',
);
