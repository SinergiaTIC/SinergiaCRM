...
while ($i <= 12) {
    ...
    $dictionary['stic_Payment_Commitments']['fields']['expected_payments_month_' . $i] = array(
        ...
        'source' => 'non-db',
        'kreporttype' => 'decimal',
        'evalSQLFunction' => 'X', // This strange parameter is required by https://github.com/SinergiaTIC/SinergiaCRM/blob/feature/paymentsPrevision/modules/KReports/KReportQuery.php#L1230 so that, on this field of type 'kreporter', the aggregations are applied in case they are used in the report.
        'eval' => array(
            'presentation' => array(
                'eval' => $mainQuery,
            ),
