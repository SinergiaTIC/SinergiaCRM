 ...
 *
 * This virtual field extracts the third value from the expected_payments_detail string,
 * which represents the expected payment amount for the month after the next (current month + 3).
...
$virtualFieldLabel = 'LBL_SDA_EXPECTED_PAYMENTS_MONTH_3';

// Description of the virtual field
$virtualFieldDescription = 'LBL_SDA_EXPECTED_PAYMENTS_DESCRIPTION_MONTH_3';
...
$virtualFieldExpression = "SUBSTRING_INDEX(SUBSTRING_INDEX(expected_payments_detail, '|', 3), '|', -1)";
