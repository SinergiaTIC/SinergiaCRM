 ...
 *
 * This virtual field extracts the sixth value from the expected_payments_detail string,
 * which represents the expected payment amount for the month after the next (current month + 6).
...
$virtualFieldLabel = 'LBL_SDA_EXPECTED_PAYMENTS_MONTH_6';

// Description of the virtual field
$virtualFieldDescription = 'LBL_SDA_EXPECTED_PAYMENTS_DESCRIPTION_MONTH_6';
...
$virtualFieldExpression = "SUBSTRING_INDEX(SUBSTRING_INDEX(expected_payments_detail, '|', 6), '|', -1)";
