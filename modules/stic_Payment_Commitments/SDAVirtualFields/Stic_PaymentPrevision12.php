 ...
 *
 * This virtual field extracts the twelfth value from the expected_payments_detail string,
 * which represents the expected payment amount for the month after the next (current month + 12).
...
$virtualFieldLabel = 'LBL_SDA_EXPECTED_PAYMENTS_MONTH_12';

// Description of the virtual field
$virtualFieldDescription = 'LBL_SDA_EXPECTED_PAYMENTS_DESCRIPTION_MONTH_12';
...
$virtualFieldExpression = "SUBSTRING_INDEX(SUBSTRING_INDEX(expected_payments_detail, '|', 12), '|', -1)";
