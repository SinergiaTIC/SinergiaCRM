 ...
 * three years ago, and 0 otherwise. It's designed to provide a quick way to 
 * filter or identify active relationships from three years ago in reports 
 * and analyses.
 */

// Label for the virtual field (can use an existing label in the module or any string)
$virtualFieldLabel = 'LBL_SDA_ACTIVE_CURRENT_YEAR_MINUS_3';

// Description of the virtual field (can use an existing label in the module or any string)
$virtualFieldDescription = 'LBL_SDA_ACTIVE_CURRENT_YEAR_MINUS_3_DESCRIPTION';
