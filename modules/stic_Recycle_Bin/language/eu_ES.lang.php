...
$mod_strings = array(
    ...
    'LBL_ASSIGNED_TO_USER' => 'Usuario asignado',
    'LBL_USER_DELETED_LINK' => 'Enlace usuario eliminador',
    'LBL_USER_RESTORED_LINK' => 'Enlace usuario restaurador',
    'LBL_MODIFIED_USER' => 'Usuario que modificó',
    'LBL_CREATED_USER' => 'Usuario que creó',
    'LBL_SECURITYGROUPS' => 'Grupos de seguridad',

    // Custom fields
    'LBL_RECORD_MODULE' => 'Módulo',
    'LBL_RECORD_ID' => 'ID del registro',
    'LBL_RECORD_NAME' => 'Nombre del registro',
    'LBL_DATE_DELETED' => 'Fecha de eliminación',
    'LBL_DELETED_BY' => 'Usuario que eliminó',
    'LBL_DATE_RESTORED' => 'Fecha de recuperación',
    'LBL_RESTORED_BY' => 'Usuario que recuperó',
    ...
    'LBL_RESTORE_RELATIONS_RESTORED' => '%d relaciones restablecidas.',
    'LBL_RESTORE_RELATIONS_SKIPPED' => '%d relaciones omitidas (registros relacionados ya no disponibles).',
