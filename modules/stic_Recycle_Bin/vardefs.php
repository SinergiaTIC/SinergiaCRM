...
$dictionary['stic_Recycle_Bin'] = array(
    ...
    'fields' => array(
        ...
        'recycle_user_deleted_name' => array(
            ...
            'link' => 'recycle_user_deleted_link',
        ),
        'recycle_user_deleted_link' => array(
            'name' => 'recycle_user_deleted_link',
            'type' => 'link',
            'relationship' => 'stic_recycle_bin_user_deleted',
            'vname' => 'LBL_RECYCLE_USER_DELETED_LINK',
            'link_type' => 'one',
            'module' => 'Users',
            'bean_name' => 'User',
            'source' => 'non-db',
        ...
        'recycle_user_restored_name' => array(
            ...
            'link' => 'recycle_user_restored_link',
        ),
        'recycle_user_restored_link' => array(
            'name' => 'recycle_user_restored_link',
            'type' => 'link',
            'relationship' => 'stic_recycle_bin_user_restored',
            'vname' => 'LBL_RECYCLE_USER_RESTORED_LINK',
            'link_type' => 'one',
            'module' => 'Users',
            'bean_name' => 'User',
            'source' => 'non-db',
    ...
    'relationships' => array(
        ...
        'stic_recycle_bin_user_deleted' => array(
            ...
            'rhs_module' => 'stic_Recycle_Bin',
            'rhs_table' => 'stic_recycle_bin',
            'rhs_key' => 'recycle_user_deleted_id',
            'relationship_type' => 'one-to-many',
        ),
        'stic_recycle_bin_user_restored' => array(
            ...
            'rhs_module' => 'stic_Recycle_Bin',
            'rhs_table' => 'stic_recycle_bin',
            'rhs_key' => 'recycle_user_restored_id',
            'relationship_type' => 'one-to-many',
        ),
    ),
);
