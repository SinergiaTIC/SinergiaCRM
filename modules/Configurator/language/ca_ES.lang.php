...
$mod_strings = array(
    ...
    'DISPLAY_RESPONSE_TIME' => 'Mostra els temps de resposta del servidor',
    'IMAGES' => 'Logotips',
    'LBL_ALLOW_USER_TABS' => 'Permet que els usuaris puguin ocultar pestanyes',
    'LBL_CONFIGURE_SETTINGS_TITLE' => 'Configuració del sistema',
    'LBL_LOGVIEW' => 'Mostra el registre',
    ...
    'LBL_ALLOW_DEFAULT_SELECTION' => 'Permet als usuaris utilitzar aquest compte per enviar correu electrònic:',
    'LBL_ALLOW_DEFAULT_SELECTION_HELP' => 'Quan aquesta opció està seleccionada, tots els usuaris podran enviar correus electrònics utilitzant el mateix compte de correu de sortida configurat per a l\'enviament de notificacions del sistema i avisos. Si l\'opció no està seleccionada, els usuaris poden utilitzar el servidor de correu de sortida després de proporcionar la informació del seu propi compte.',
    'LBL_MAILMERGE' => 'Combina la correspondència',
    'LBL_MIN_AUTO_REFRESH_INTERVAL' => 'Interval mínim de l\'actualització automàtica del Dashlet',
    'LBL_MIN_AUTO_REFRESH_INTERVAL_HELP' => 'Valor mínim que es pot triar per a l\'actualització automàtica dels dashlets. Si s\'indica \'Mai\' es desactiva l\'actualització automàtica.',
    'LBL_MODULE_FAVICON' => 'Mostra la icona del mòdul com a favicon',
    'LBL_MODULE_FAVICON_HELP' => 'Si el mòdul té icona, es farà servir com a favicon a la pestanya del navegador en comptes del favicon del tema.',
    ...
    'LBL_NOTIFY_SUBJECT' => 'Assumpte del correu electrònic:',
    ...
    'LBL_PROXY_PASSWORD' => 'Contrasenya',
    'LBL_PROXY_PORT' => 'Port',
    ...
    'LBL_USE_REAL_NAMES' => 'Mostra el nom complet (no l\'id de l\'usuari)',
    'LBL_USE_REAL_NAMES_DESC' => 'Mostra el nom complet d\'un usuari en comptes del seu identificador',
    'LBL_DISALBE_CONVERT_LEAD' => 'Deshabilita l\'acció de convertir clients potencials per a clients potencials convertits',
    ...
    'LBL_ENABLE_ACTION_MENU' => 'Mostra accions dins dels menús',
    'LBL_ENABLE_ACTION_MENU_DESC' => 'Si s\'activa, les accions d\'una vista de detall o d\'un subpanell es mostraran en un menú desplegable. Si no s\'activa, les accions es mostraran com a botons separats.',
    'LBL_ENABLE_INLINE_EDITING_LIST' => 'Habilita l\'edició en línia a la vista de llista',
    'LBL_ENABLE_INLINE_EDITING_LIST_DESC' => 'Habilita l\'edició en línia dels camps de la vista de llista.',
    'LBL_ENABLE_INLINE_EDITING_DETAIL' => 'Habilita l\'edició en línia a la vista de detall',
    'LBL_ENABLE_INLINE_EDITING_DETAIL_DESC' => 'Habilita l\'edició en línia dels camps de la vista de detall.',
    'LBL_HIDE_SUBPANELS' => 'Subpanells col·lapsats',
    'LIST_ENTRIES_PER_LISTVIEW' => 'Registres per pàgina a les vistes de llista',
    'LIST_ENTRIES_PER_SUBPANEL' => 'Registres per pàgina als subpanells',
    'LOG_MEMORY_USAGE' => 'Registra la utilització de memòria',
    'LOG_SLOW_QUERIES' => 'Registra les consultes lentas',
    'CURRENT_LOGO' => 'Logotip actual',
    'CURRENT_LOGO_HELP' => 'Aquest logotip es mostra al centre de la pantalla d\'inici de sessió.',
    'NEW_LOGO' => 'Puja un nou logotip',
    'NEW_LOGO_HELP' => 'El format d\'imatge pot ser .png o .jpg. L\'alçada màxima ha de ser de 170px i l\'amplada màxima, de 450px. Qualsevol imatge carregada que sigui més gran en qualsevol dimensió serà modificada per respectar aquestes dimensions màximes.',
    'NEW_LOGO_HELP_NO_SPACE' => 'El format d\'imatge pot ser .png o .jpg. L\'alçada màxima ha de ser de 170px i l\'amplada màxima, de 450px. Qualsevol imatge carregada que sigui més gran en qualsevol dimensió serà modificada per respectar aquestes dimensions màximes.',
    'SLOW_QUERY_TIME_MSEC' => 'Temps llindar per a les consultes lentes (ms)',
    'STACK_TRACE_ERRORS' => 'Mostra la traça de la pila d\'errors',
    'UPLOAD_MAX_SIZE' => 'Mida màxim per a la pujada de fitxers',
    'VERIFY_CLIENT_IP' => 'Valida l\'adreça IP de l\'usuari',
    'LOCK_HOMEPAGE' => 'No permetis el disseny personalitzat de la pàgina d\'inici',
    'LOCK_SUBPANELS' => 'No permetis el disseny personalitzat dels subpanells',
    'MAX_DASHLETS' => 'Nombre màxim de Dashlets a la pàgina d\'inici',
    'SYSTEM_NAME' => 'Nom del sistema',
    'SYSTEM_NAME_WIZARD' => 'Nom:',
    'SYSTEM_NAME_HELP' => 'Aquest és el nom que es mostrarà a la barra de títol del navegador.',
    'LBL_LDAP_TITLE' => 'Suport d\'autentificació LDAP',
    'LBL_LDAP_ENABLE' => 'Habilita LDAP',
    'LBL_LDAP_SERVER_HOSTNAME' => 'Servidor:',
    'LBL_LDAP_SERVER_PORT' => 'Port:',
    'LBL_LDAP_ADMIN_USER' => 'Nom d\'usuari:',
    'LBL_LDAP_ADMIN_USER_DESC' => 'S\'utilitza per cercar l\'usuari LDAP. És possible que hagi d\'estar completament qualificat.',
    'LBL_LDAP_ADMIN_PASSWORD' => 'Contrasenya:',
    'LBL_LDAP_AUTHENTICATION' => 'Autentificació:',
    'LBL_LDAP_AUTHENTICATION_DESC' => 'Enllaçar al servidor LDAP utilitzant credencials d\'usuaris específiques. Si no es proporcionen es vincularà de forma anònima.',
    'LBL_LDAP_AUTO_CREATE_USERS' => 'Crea els usuaris automàticament:',
    ...
    'LBL_LDAP_GROUP_USER_ATTR_DESC' => 'L\'identificador únic de persona que serà utilitzat per comprovar si és membre d\'un grup. Exemple: <em>uid</em>',
    ...
    'DEVELOPER_MODE' => 'Mode desenvolupador',

    'SHOW_DOWNLOADS_TAB' => 'Mostra la pestanya de descàrregues',
    'SHOW_DOWNLOADS_TAB_HELP' => 'Si s\'activa, la pestanya de descàrregues apareixerà a la configuració d\'usuari i proporcionarà accés a extensions de SuiteCRM i a d\'altres fitxers disponibles.',
    'LBL_LDAP_ENC_KEY_DESC' => 'Per a l\'autentificació SOAP quan es fa servir LDAP.',
    'LDAP_ENC_KEY_NO_FUNC_DESC' => 'L\'extensió php_mcrypt ha d\'estar habilitada al fitxer php.ini.',
    'LDAP_ENC_KEY_NO_FUNC_OPENSSL_DESC' => 'L\'extensió openssl es pot habilitar al fitxer php.ini.',
    'LBL_ALL' => 'Tot',
    'LBL_MARK_POINT' => 'Marca un punt',
    'LBL_NEXT_' => 'Següent >>',
    'LBL_REFRESH_FROM_MARK' => 'Actualitza-ho des de la marca',
    'LBL_SEARCH' => 'Cerca:',
    'LBL_REG_EXP' => 'Expressió regular:',
    'LBL_IGNORE_SELF' => 'Ignora les dades pròpies:',
    'LBL_MARKING_WHERE_START_LOGGING' => 'Marcant des d\'on iniciar el registre',
    'LBL_DISPLAYING_LOG' => 'Mostrant el registre',
    'LBL_YOUR_PROCESS_ID' => 'ID del procés',
    'LBL_YOUR_IP_ADDRESS' => 'La vostra adreça IP és',
    'LBL_IT_WILL_BE_IGNORED' => ' Serà ignorat ',
    'LBL_LOG_NOT_CHANGED' => 'El registre no ha canviat',
    'LBL_ALERT_JPG_IMAGE' => 'El format de la imatge ha de ser JPEG. Pugeu un nou fitxer amb extensió .jpg.',
    'LBL_ALERT_TYPE_IMAGE' => 'El format de la imatge ha de ser JPEG o PNG. Pugeu un nou fitxer amb extensió .jpg o .png.',
    'LBL_ALERT_SIZE_RATIO' => 'La relació d\'aspecte de la imatge hauria de ser entre 1:1 i 10:1. La imatge serà redimensionada.',
    'ERR_ALERT_FILE_UPLOAD' => 'Error al pujar la imatge.',
    ...
    'LEAD_CONV_OPT_HELP' => "<b>Copy</b> - crea i fa còpies de totes les activitats de la iniciativa a registres nous que són seleccionats per l'usuari durant la conversió. Les còpies són creades per a cadascun dels registres seleccionats.<br><br><b>Move</b> - totes les activitats del client potencial es traslladen a un nou registre que és seleccionat per l'usuari durant la conversió.<br><br><b>Do nothing</b> - no fa res amb activitats de la iniciativa durant la conversió. Les activitats queden relacionades només amb el client potencial.",
    'LBL_CONFIG_AJAX' => 'Configura la interfície d\'usuari AJAX',
    'LBL_CONFIG_AJAX_DESC' => 'Activa o desactiva l\'ús de la interfície d\'usuari AJAX per a mòduls específics.',
    'LBL_LOGGER_MAX_LOGS' => 'Número màxim de fitxers de registre (abans de la rotació)',
    'LBL_LOGGER_FILENAME_SUFFIX' => 'Afegeix després del nom d\'arxiu',
    'LBL_VCAL_PERIOD' => 'Període de temps per actualizacions vCal:',
    'LBL_IMPORT_MAX_RECORDS' => 'Importar - Màxim nombre de registres:',
    'LBL_IMPORT_MAX_RECORDS_HELP' => 'Especifica quants registres es permeten dins dels arxius d\'importació.<br>L\'usuari serà avisat si el nombre de registres excedeix aquest valor.<br>Si no s\'indica cap valor s\'acceptarà un nombre il·limitat de registres.',
    'vCAL_HELP' => 'Feu servir aquesta opció per determinar el nombre de mesos per endavant sobre la data actual amb la qual es publica la informació relativa a l\'estat de Disponible/Ocupat sobre trucades i reunions.</br>Per desactivar la publicació de l\'estat Disponible/Ocupat, indiqueu el valor 0. El mínim es 1 mes; el màxim, 12.',
...
(L\'alçada de la lletra pela ràtio de l\'alçada de la cel·la) també és utilitzada com a alçada de la cel·la quant l\'alçada no està definida.',
    ...
    'LBL_FONT_LIST_EMBEDDED_INFO' => 'Marqueu aquesta opció per incrustar la font al fitxer PDF',
    ...
    'LBL_ADD_FONT' => 'Afegeix una font',
    'LBL_BACK' => 'Enrere',
    'LBL_REMOVE' => 'Elimina',
    'LBL_JS_CONFIRM_DELETE_FONT' => 'Segur que voleu eliminar aquesta font?',

    'LBL_ADDFONT_TITLE' => 'Afegeix una font PDF',
    'LBL_PDF_ENCODING_TABLE' => 'Taula de codificació',
    'LBL_PDF_ENCODING_TABLE_INFO' => 'Nom de la taula de codificació. <br> Aquesta opció s\'ignora per TrueType Unicode, OpenType Unicode i fonts de símbols.<br> La codificació defineix l\'associació entre un codi (de 0 a 255) i un caràcter contingut a la font.<br> Els primers 128 són fixos i corresponen a ASCII.',
    ...
    'LBL_ADD_FONT_BUTTON' => 'Afegeix',
    'JS_ALERT_PDF_WRONG_EXTENSION' => 'Aquest fitxer no té una extensió vàlida.',
    ...
    'LBL_STATUS_FONT_SUCCESS' => 'ÈXIT: La font s\'ha afegit a SuiteCRM.',
...
// Wizard
    //Wizard Scenarios
    'LBL_WIZARD_SCENARIOS' => 'Escenaris',
    'LBL_WIZARD_SCENARIOS_EMPTY_LIST' => 'No s\'han configurat escenaris',
    'LBL_WIZARD_SCENARIOS_DESC' => 'Trieu quins escenaris són apropiats per a la instal·lació. Aquestes opcions es poden canviar després de la instal·lació.',

    'LBL_WIZARD_TITLE' => 'Assistent d\'administració',
    'LBL_WIZARD_WELCOME_TAB' => 'Benvingut',
    'LBL_WIZARD_WELCOME_TITLE' => 'Benvingut a SuiteCRM!',
    'LBL_WIZARD_WELCOME' => 'Feu clic a <b>Següent</b> per localitzar i configurar SuiteCRM ara. Si voleu configurar SuiteCRM després, feu clic a <b>Salta</b>.',
    ...
    'LBL_WIZARD_SYSTEM_DESC' => 'Proporcioneu el nom i el logotip de la vostra organització.',
    'LBL_WIZARD_LOCALE_DESC' => 'Especifiqueu com voleu que les dades siguin mostrades basant-vos en la ubicació geogràfica. La configuració que indiqueu aquí serà utilitzada per defecte per als nous usuaris, que després podran establir les seves pròpies preferències.',
    'LBL_WIZARD_SMTP_DESC' => 'Indiqueu el compte de correu electrònic que s\'utilitzarà per enviar missatges de correu electrònic, com ara les notificacions d\'assignació o les noves contrasenyes d\'usuari. Els usuaris rebran correus electrònics de l\'aplicació com si s\'haguessin enviat des del compte de correu electrònic especificat.',
    ...
    'LBL_ENABLE_HISTORY_CONTACTS_EMAILS' => 'Mostra els correus electrònics relacionats al subpanell Historial dels mòduls',

    // Google auth PR 6146
    'LBL_GOOGLE_AUTH_TITLE' => 'Autenticació de Google',
    'LBL_GOOGLE_AUTH_JSON' => 'Fitxer JSON',
    'LBL_GOOGLE_AUTH_JSON_HELP' => 'Carrega el fitxer JSON que heu descarregat de la consola de desenvolupadors de Google.',
