...
$dictionary['Campaign'] = array('audited' => true,
    ...
    'fields' => array(
        ...
        'em_template_id' => array(
            'required' => false,
            'name' => 'em_template_id',
            'vname' => 'LBL_EM_TEMPLATE_ID',
            'type' => 'enum',
            'massupdate' => 0,
            'no_default' => false,
            'source' => 'non-db',
        ...
        'em_outbound_email_id' => array(
            'name' => 'em_outbound_email_id',
            'vname' => 'LBL_EM_OUTBOUND_EMAIL_ID',
            'type' => 'enum',
            'source' => 'non-db',
            'isnull' => true,
            'required' => false,
        ...
        'em_from_addr' => array(
            'name' => 'em_from_addr',
            'vname' => 'LBL_EM_FROM_ADDR',
            'type' => 'varchar',
            'source' => 'non-db',
            'len' => '100',
            'required' => false,
        ),
        'em_reply_to_name' => array(
            'name' => 'em_reply_to_name',
            'vname' => 'LBL_EM_REPLY_TO_NAME',
            'type' => 'varchar',
            'source' => 'non-db',
            'len' => '100',
        ),
        'em_reply_to_addr' => array(
            'name' => 'em_reply_to_addr',
            'vname' => 'LBL_EM_REPLY_TO_ADDR',
            'type' => 'varchar',
            'source' => 'non-db',
            'len' => '100',
        ),
