...
$mod_strings = array(
    ...
    'LBL_FROM_ADDR_DESC' => 'O enderezo de correo electrónico posto aquí non apareza no campo "De" enderezo do correo electrónico do remitente debido ás restricións impostas polo proveedor de servizos de correo electrónico. Nestas circunstancias, o enderezo de correo electrónico que se define é a do servidor de correo saínte que esta configurado.', // as long as XTemplate doesn't support output escaping, transform quotes to html-entities right here (bug #48913)
