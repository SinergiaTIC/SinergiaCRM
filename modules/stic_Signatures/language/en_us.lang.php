...
$mod_strings = array(
    ...
    'LBL_EMAILS_SENT_MSG' => 'email(s) sent successfully to signers',
    'LBL_EMAILS_NOT_SENT_MSG' => 'email(s) not sent because the signer has no email address or an error occurred',
    'LBL_EMAIL_STATUS_SENT' => 'Email sent',
    'LBL_EMAIL_STATUS_NOT_SENT' => 'Email not sent',
    'LBL_ADDED_STATUS_OK' => 'Added successfully',
    ...
    'LBL_NO_SIGNATURE_FOR_SIGNER' => 'No signature process exists for the selected signer.',
    ...
    'LBL_PORTAL_INVALID_OTP_CODE' => 'The provided one time code is not valid. Please try again.',
    'LBL_PORTAL_UNKNOWN_AUTHENTICATION_MODE' => 'The authentication mode is not valid.',
    ...
    'LBL_PORTAL_INVALID_FIELD_VALUE' => 'The entered value is not valid. Please try again.',
