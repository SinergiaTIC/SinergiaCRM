...
$mod_strings = array(
    ...
    'LBL_PORTAL_OTP_INSTRUCTION' => 'To continue, please enter the one-time verification code in the following form.<br>Please use the available options to receive the code.',
    'LBL_PORTAL_OTP_CHECK_BTN' => 'Check code',
    'LBL_PORTAL_OTP_DONT_RECEIVED' => 'Didn\'t receive the code?',
    ...
    'LBL_PORTAL_OTP_EMAIL_SENT' => 'A new One-Time Password has been sent by email. Please check your inbox.',
    'LBL_PORTAL_OTP_PHONE_SENT' => 'A new One-Time Password has been sent by phone. Please check your device.',
    ...
    'LBL_ACTIVATION_DATE_HELP' => 'Date from which the signer will be able to sign the document. Before this date, the signature portal will not allow the document to be signed. By default, the day after at 00:00 hours.',
    'LBL_EXPIRATION_DATE_HELP' => 'Deadline for the signer to sign the document. After this date, the signature portal will not allow the document to be signed, but access to consult it will be allowed if it is already signed.',
    'LBL_STATUS_HELP' => 'Current status of the signing process. <ul><li><strong>Draft:</strong> The signing process is being configured and has not yet been sent to the signers. <li><strong>Sent:</strong> The signing process has been sent to the signers and is pending completion. <li><strong>Completed:</strong> All signers have signed the document and the signing process has been completed. <li><strong>Expired:</strong> The period to sign the document has expired without all signers having signed it. </ul>',
