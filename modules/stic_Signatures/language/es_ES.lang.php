...
$mod_strings = array(
    ...
    'LBL_PORTAL_OTP_INSTRUCTION' => 'Para continuar es necesario introducir un código de un solo uso en el siguiente formulario.<br>Por favor utilice las opciones disponibles para recibir el código.',
    ...
    'LBL_PORTAL_ENTER_NAME_TEXT' => 'Por favor, escriba su nombre para generar la firma de texto.',
    'LBL_PORTAL_CLOSE' => 'Cerrar',
    'LBL_PORTAL_ERROR' => 'Error',
    'LBL_PORTAL_IMG_ERROR' => 'No se pudo cargar la imagen. Por favor, asegúrese de que es un archivo PNG o JPG válido.',
    'LBL_PORTAL_DRAW_OR_USE_OTHER_OPTION' => 'Por favor, dibuje su firma o use una opción alternativa antes de guardar.',
    'LBL_PORTAL_SIGNATURE_SAVED' => 'Firma guardada',
    'LBL_PORTAL_SIGNATURE_SAVED_SUCCESSFULLY' => 'La firma se ha guardado correctamente.',
    'LBL_PORTAL_UNEXPECTED_SAVE_ERROR' => 'Ha ocurrido un error inesperado al guardar la firma. Por favor, inténtelo de nuevo.',
    ...
    'LBL_PORTAL_FIELD_VALIDATION_INSTRUCTION' => 'Por favor, para continuar indique el valor de su',
    'LBL_PORTAL_VALIDATE_FIELD_BTN' => 'Siguiente',
    'LBL_PORTAL_FIELD_VALIDATION_LABEL_PHONE' => 'TELEFONO MÓVIL',
    ...
    'LBL_PORTAL_OTP_EMAIL_SENT' => 'Se ha enviado un nuevo código de un solo uso por correo electrónico. Por favor, revise su bandeja de entrada.',
    'LBL_PORTAL_OTP_PHONE_SENT' => 'Se ha enviado un nuevo código de un solo uso a su teléfono. Por favor, revise su dispositivo.',
