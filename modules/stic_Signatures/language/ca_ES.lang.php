...
$mod_strings = array(
    ...
    'LBL_EMAILS_SENT_MSG' => 'correu(s) electrònic(s) enviat(s) correctament als firmants',
    'LBL_EMAILS_NOT_SENT_MSG' => "correu(s) electrònic(s) no enviat(s) perquè el firmant no té adreça de correu o s'ha produït un error",
    'LBL_EMAIL_STATUS_SENT' => 'Correu enviat',
    'LBL_EMAIL_STATUS_NOT_SENT' => 'Correu no enviat',
    'LBL_ADDED_STATUS_OK' => 'Afegit correctament',
