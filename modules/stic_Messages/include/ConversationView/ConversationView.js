...
/**
 * Safe default for when the script is loaded outside the conversation popup
 * (e.g. Contacts / Accounts detail view) so that referencing CONVERSATION
...
if (CONVERSATION.parentId && CONVERSATION.parentType) {
