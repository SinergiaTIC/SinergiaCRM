...
(function ($) {
  ...
  $.fn.stic_MessagesComposeView = function (options) {
     ...
     * $('.compose-view#id).stic_MessagesComposeView().qtipBar +=
     ...
     * $('.compose-view#id).stic_MessagesComposeView().qtipBar += '<button class="btn btn-default btn-sm"></button>';
     *
     * @type {string}
     */
    self.qtipBar =
    ...
    self.handleQTipBarClick = function () {
      ...
      $.fn.stic_MessagesComposeView.setEmailAddressFieldFromPopup = function(resultData) {
      ...
      var popupWindow = open_popup(
        ...
        false,
        {
          "call_back_function": '$.fn.stic_MessagesComposeView.setEmailAddressFieldFromPopup',
    ...
    $.fn.stic_MessagesComposeView.updateSignature = self.updateSignature = function () {
    ...
    self.attachDocument = function (event) {
      ...
      $.fn.stic_MessagesComposeView.selectDocumentFromPopup = function(resultData) {
      ...
      var showSelectDocumentDialog = function () {
        ...
        var popupWindow = open_popup(
          ...
          false,
          {
            "call_back_function": '$.fn.stic_MessagesComposeView.selectDocumentFromPopup',
            "form_name": "ComposeView",
            "field_to_name_array": {
    ...
    self.onSavingDraft = function () {
      ...
      $.ajax({
        ...
        if (typeof response.errors !== "undefined") {
          ...
          $.fn.stic_MessagesComposeView.checkForDraftAttachments(response.data.id);
        }
      }).fail(function (response) {
        "use strict";
        response = JSON.parse(response);
    ...
    self.construct = function () {
      ...
      if (self.find("[name=record]").val().length > 0) {
        $.fn.stic_MessagesComposeView.checkForDraftAttachments(self.find("[name=record]").val());
      }
      ...
      if ($(self).find('#from_addr_name').length !== 0) {
        ...
        $.ajax({
          ...
          if (typeof json.errors !== "undefined") {
            $.fn.stic_MessagesComposeView.showAjaxErrorMessage(json);
          }
        }).error(function (response) {
      ...
      if (typeof tinymce === "undefined") {
        console.error('stic_MessagesComposeView - Missing Dependency: Cannot find tinyMCE.');
  ...
  $.fn.stic_MessagesComposeView.checkForDraftAttachments = function (id) {
    ...
    $.ajax({
      ...
      if (typeof response.errors !== "undefined") {
        $.fn.stic_MessagesComposeView.showAjaxErrorMessage(response);
      }
    }).error(function (response) {
      console.error(response);
    });
  ...
  $.fn.stic_MessagesComposeView.loadAttachmentDataFromAjaxResponse = function (response) {
...
debugger;
    var confirmed = function (args) {
      ...
      $.post('index.php?entryPoint=emailTemplateData', {
        ...
        // $.fn.stic_MessagesComposeView.updateSignature();
  ...
  $.fn.stic_MessagesComposeView.defaults = {
    "tinyMceOptions": {
      menubar: false,
      plugins: ['link'],
