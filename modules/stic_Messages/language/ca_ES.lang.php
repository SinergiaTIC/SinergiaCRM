...
$mod_strings = array (
  ...
  'LBL_WHATSAPP_WEB_RETRY' => 'Els missatges de WhatsApp Web no es poden reintentar. Ja van ser enviats mitjançant el client.',
  ...
  'LBL_CONVERSATION_WINDOW_OPEN' => 'Finestra oberta — es tancarà en %1$sh %2$sm',
  'LBL_CONVERSATION_WINDOW_CLOSED' => 'Finestra tancada des de %1$s',
  'LBL_CONVERSATION_NO_HISTORY' => 'Sense conversa anterior — només es poden enviar plantilles verificades',
  'LBL_CONVERSATION_WINDOW_CLOSED_HINT' => 'Per iniciar una conversa, envieu una plantilla verificada des del mòdul de Missatges.',
  'LBL_CONVERSATION_NEW_MESSAGE_BTN' => 'Nou missatge',
  'LBL_CONVERSATION_PLACEHOLDER' => 'Escriu un missatge…',
  'LBL_CONVERSATION_SEND' => 'Envia',
  'LBL_CONVERSATION_ATTACH' => 'Adjunta fitxer',
  'LBL_CONVERSATION_REMOVE_ATTACHMENT' => 'Elimina adjunt',
  'LBL_CONVERSATION_UPLOADING' => 'Pujant fitxer…',
  'LBL_CONVERSATION_ERROR_UPLOAD' => 'Error al pujar fitxer',
  'LBL_CONVERSATION_ERROR_UNKNOWN' => 'Error desconegut',
  'LBL_CONVERSATION_ERROR_SEND' => 'Error al enviar missatge',
  'LBL_ERROR_NO_FILE_RECEIVED' => 'No s\'ha rebut cap fitxer',
  'LBL_ERROR_UNSUPPORTED_FILE_TYPE' => 'Tipus de fitxer no suportat per WhatsApp',
