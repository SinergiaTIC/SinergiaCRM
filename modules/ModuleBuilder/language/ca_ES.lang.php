...
$mod_strings = array(
    ...
    'help' => array(
        'package' => array(
            ...
            'create' => "Proporcioneu un <b>Nom</b> per al paquet. El nom que introduïu ha de ser alfanumèric i no pot contenir espais. (Exemple: HR_Management)<br/><br/> Podeu proporcionar informació de l'<b>Autor</b> i la <b>Descripció</b> del paquet. <br/><br/>Feu clic a <b>Desa</b> per crear el paquet.",
            'deletebtn' => 'Feu clic a <b>Elimina</b> per eliminar aquest paquet i tots els arxius relacionats.',
            'deploybtn' => 'Feu clic a <b>Desplega</b> per desar totes les dades introduïdes i instal·lar el paquet, incloent tots els mòduls, en la instància actual.',
            'description' => 'Aquesta és la <b>Descripció</b> del paquet que es mostra durant la instal·lació.',
            'duplicatebtn' => 'Feu clic a <b>Duplica</b> per copiar el contingut del paquet en un paquet nou i mostrar-lo. <br/><br/>El nom del nou paquet es crearà automàticament afegint un número al final del nom del paquet original. Podeu canviar el nom del nou paquet introduint un nou <b>Nom</b> i fent clic a <b>Desa</b>.',
            'existing_module' => 'Feu clic a la icona <b>Mòdul</b> per editar les propietats i personalitzar els camps, relacions i dissenys associats al mòdul.',
            'exportbtn' => 'Feu clic a <b>Exporta</b> per crear un fitxer .zip que contingui les personalitzacions fetes al paquet.<br><br> El fitxer generat no és una versió instal·lable del paquet.<br><br>Utilitzeu el <b>Carregador de Mòduls</b> per importar ek fitxer .zip per tal que el paquet, personalitzacions incloses, aparegui al <b>Constructor de Mòduls</b>.',
            'key' => 'Aquesta <b>Clau</b> alfanumèrica de 5 lletres es farà servir per prefixar tots els directoris, noms de classes i taules de base de dades de tots els mòduls del paquet.<br><br>La clau es fa servir per contribuir a la unicitat dels noms de taules.',
            'modify' => "Aquí es mostren les propietats i les accions que es poden fer amb el paquet.<br><br>Podeu modificar-ne el <b>Nom</b>, l'<b>Autor</b> i la <b>Descripció</b>, així com veure i personalitzar qualsevol dels mòduls que contingui.<br><br>Feu clic a <b>Nou mòdul</b> per crear un mòdul al paquet.<br><br>Si el paquet conté almenys un mòdul, podeu <b>publicar-lo</b> i <b>desplegar-lo</b>, així com <b>exportar</b> les personaltizacions que s'hi hagin fet.",
            'name' => 'Aquest és el <b>Nom</b> del paquet actual. <br/><br/>El nom que introduïu ha de ser alfanumèric, començar per una lletra i no pot contenir espais. (Exemple: HR_Management)',
            'new_module' => 'Feu clic a <b>Nou Mmòdul</b> per crear un nou mòdul al paquet.',
            'publishbtn' => 'Feu clic a <b>Publica</b> per desar totes les dades introduïdes i crear un fitxer .zip que serà una versió instal·lable del paquet.<br><br>Utilitzeu el <b>Carregador de Mòduls</b> per pujar el fitxer .zip i instal·lar el paquet.',
            'readme' => 'Feu clic per agregar un text <b>Llegeix-me</b>, que es mostrarà en el moment de la instal·lació del paquet.',
            'savebtn' => 'Feu clic a <b>Desa i Desplega</b> per desar tots els canvis fets i aplicar-los al mòdul.',
        ),
        'main' => array(),
        'module' => array(
            'acl' => 'Marcant aquesta opció habilitareu els Controls d&#39;Accés per a aquest mòdul, incloent-hi la seguretat a nivell de camp.',
            'assignable' => 'Marcant aquesta opció permetreu que un registre d&#39;aquest mòdul sigui assignat a un usuari.',
            'audit' => 'Marcant aquesta opció habilitareu l&#39;Auditoria en aquest mòdul. Els canvis a alguns dels camps seran registrats de manera que els administradors puguin revisar-ne l&#39;historial.',
            ...
            'deletebtn' => 'Feu clic a <b>Elimina</b> per eliminar aquest mòdul.',
            'duplicatebtn' => 'Feu clic a <b>Duplica</b> per copiar les propietats del mòdul en un mòdul nou i mostrar-lo.<br/> El nom del nou mòdul es crearà automàticament afegint un número al final del nom del paquet original.',
            'has_tab' => 'Marcant <b>Pestanya de Navegació</b> proveireu el mòdul d&#39;una pestanya de navegació.',
            'importable' => 'Marcant l&#39;opció <b>Importable</b> s&#39;habilitarà la importació per a aquest mòdul.<br><br>Un enllaç a l&#39;Assistent d&#39;Importació apareixerà al panell de dreceres del mòdul. L&#39;Assistent d&#39;Importació facilitarà la importació de dades provinents de fonts externes al mòdul personalitzat.',
            'label' => 'Aquesta és l&#39;<b>Etiqueta</b> que apareixerà a la pestanya de navegació del mòdul.',
            'modify' => 'Podeu canviar les propietats del mòdul o personalitzar-ne els <b>Camps</b>, les <b>Relacions</b> i els <b>Dissenys</b>.',
            ...
            'reportable' => 'Marcant aquesta opció permetreu que es puguin generar informes associats a aquest mòdul.',
            'savebtn' => 'Feu clic a <b>Desa</b> per desar tota la informació relacionada amb el mòdul.',
            'studio' => 'Marcant aquesta opció permetreu que els administradors personalitzin aquest mòdul a l&#39;Estudi.',
            'team_security' => 'Marcant l&#39;opció <b>Seguretat d&#39;Equips</b> s&#39;habilitarà la seguretat d&#39;equips per a aquest mòdul.<br/><br/>Si la seguretat d&#39;equips està habilitada, el camp de selecció d&#39;Equip apareixerà als registres del mòdul.',
            ...
            'viewfieldsbtn' => 'Feu clic a <b>Camps</b> per veure els camps del mòdul i crear i editar camps personalitzats.',
            'viewlayoutsbtn' => 'Feu clic a <b>Dissenys</b> per veure els dissenys del mòdul i personalitzar-hi la disposició dels camps.',
            'viewrelsbtn' => 'Feu clic a <b>Relacions</b> per veure les relacions del mòdul i crear-ne de noves.',
        ),
        'dropdowns' => array(
        ...
        'subPanelEditor' => array(
            ...
            'historyBtn' => 'Feu clic a <b>Historial</b> per veure i restaurar un disseny desat prèviament.',
            'historyDefault' => 'Feu clic a <b>Restaura els valors per defecte</b> per restaurar la vista al format original.',
            'modify' => 'Aquí hi apareixen tots els camps que es poden mostrar al <b>subpanell</b>. La columna <b>Per defecte</b> conté els camps que es mostren al subpanell.<br /><br/> La columna <b>Ocults</b> conté els camps que es poden afegir a la columna <b>Per defecte</b>.',
            'savebtn' => "Feu clic a <b>Desa i Desplega</b> per desar els canvis realitzats i s'apliquin al mòdul.",
        ),
...
//STUDIO2
    ...
    'LBL_SELECT_FILE' => "Selecciona l'arxiu",
    ...
    'LBL_EDIT_DROPDOWNS' => 'Edita una llista desplegable global',
    'LBL_ADD_DROPDOWN' => 'afegeix una nova llista desplegable global',
    'LBL_BLANK' => '-buit-',
...
//SECTION
    'LBL_SECTION_EDLABELS' => 'Edita les etiquetes',
    ...
    'LBL_SECTION_DROPDOWNED' => 'Edita la llista desplegable',
    'LBL_SECTION_HELP' => 'Ajuda',
    'LBL_SECTION_MAIN' => 'Principal',
    'LBL_SECTION_FIELDEDITOR' => 'Edita el camp',
    'LBL_SECTION_DEPLOY' => 'Desplega',
