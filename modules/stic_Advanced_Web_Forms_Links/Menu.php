...
if(ACLController::checkAccess('stic_Advanced_Web_Forms_Links', 'list', true)){
    $module_menu[] = 
    array(
        'index.php?module=stic_Advanced_Web_Forms_Links&action=index&return_module=stic_Advanced_Web_Forms_Links&return_action=DetailView', 
...
if(ACLController::checkAccess('stic_Advanced_Web_Forms_Responses', 'list', true)){
    $module_menu[] = 
    array(
        'index.php?module=stic_Advanced_Web_Forms_Responses&action=index&return_module=stic_Advanced_Web_Forms_Links&return_action=index', 
...
if(ACLController::checkAccess('stic_Advanced_Web_Forms_Response_Details', 'list', true)){
    $module_menu[] = 
    array(
        'index.php?module=stic_Advanced_Web_Forms_Response_Details&action=index&return_module=stic_Advanced_Web_Forms_Links&return_action=index', 
...
if(ACLController::checkAccess('stic_Advanced_Web_Forms', 'list', true)){
    $module_menu[] = 
    array(
        'index.php?module=stic_Advanced_Web_Forms&action=index&return_module=stic_Advanced_Web_Forms_Links&return_action=index', 
