...
$mod_strings = array(
    ...
    'LNK_NEW_RECORD' => 'Crea un Firmant',
    ...
    'LBL_SIGNER_EMAIL_SUBJECT' => 'Teniu un document per firmar',
    'LBL_SIGNER_EMAIL_BODY' => "Feu clic a l'enllaç següent per firmar el document:",
    'LBL_SIGNER_EMAIL_ERROR' => "Error a l'enviar el correu electrònic al firmant.",
    'LBL_SIGNER_EMAIL_SUCCESS' => "El correu electrònic s'ha enviat correctament al firmant.",
    'LBL_SIGNER_EMAIL_BUTTON_TEXT' => 'Ves al document',
    'LBL_SIGNER_EMAIL_LINK_PROBLEM' => "Si no hi podeu accedir al fer clic al correu, copieu i enganxeu l'enllaç al navegador.",
    ...
    'LBL_SIGNATURE_DATE_HELP' => "Data en què s'ha signat el document.",
    ...
    'LBL_RECORD_NAME_HELP' => 'Nom del registre relacionat amb la signatura, a partir del qual es va generar el registre del firmant.',
