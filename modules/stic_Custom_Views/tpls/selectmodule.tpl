		...
		{foreach from=$buttons item='button' key='buttonName'}
			...
			<td {if isset($button.help)}id="{$button.help}"{/if} width="16%" name=helpable" style="padding: 5px;"  valign="top" align="center">
			     <table class='CustomViewButton'>
			         <tr>
						<td align="center">
							<a class='studiolink' href="./index.php?module=stic_Custom_Views&action=EditView&view_module={$button.module}">
					 ...
					 <tr>
						 <td align="center">
							 <a class='studiolink' id='{$button.linkId}' href="./index.php?module=stic_Custom_Views&action=EditView&view_module={$button.module}">
                                 {$buttonName}
							 </a>
						 </td>
				     </tr>
...
<div style="float:left; left:-100px; display: hidden;">&nbsp;
	{literal}
	<style type='text/css'>
		.customViewsModules { padding: 5px; text-align:center; font-weight:bold}
	</style>
    {/literal}
</div>
