		...
		{foreach from=$buttons item='button' key='buttonName'}
			...
			<td {if isset($button.help)}id="{$button.help}"{/if} width="16%" name=helpable" style="padding: 5px;"  valign="top" align="center">
			     <table class='CustomViewButton'>
			         <tr>
						<td align="center">
							<a class='studiolink' href="./index.php?module=stic_Custom_Views&action=list&module_view={$button.module}">
					 ...
					 <tr>
						 <td align="center">
							 <a class='studiolink' id='{$button.linkId}' href="./index.php?module=stic_Custom_Views&action=list&module_view={$button.module}">
                                 {$buttonName}
							 </a>
						 </td>
				     </tr>
