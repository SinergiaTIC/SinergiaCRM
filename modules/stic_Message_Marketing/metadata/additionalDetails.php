...
function additionalDetailsstic_Message_Marketing($fields, SugarBean $bean = null, $params = array())
{
    ...
    if (file_exists('custom/modules/' . $bean->module_name . '/metadata/customAdditionalDetails.php')) {
        ...
        return customAdditionalDetails::customAdditionalDetailsstic_Message_Marketing($fields, $bean, $mod_strings);
