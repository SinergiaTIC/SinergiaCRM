...
$mod_strings = array(
    ...
    'LNK_NEW_RECORD' => 'Create a Booking',
    'LNK_LIST' => 'View Bookings',
    'LNK_IMPORT_STIC_BOOKINGS' => 'Import Bookings',
    'LBL_SEARCH_FORM_TITLE' => 'Search Bookings',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'View History',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Activities',
    'LBL_STIC_BOOKINGS_SUBPANEL_TITLE' => 'Bookings',
    'LBL_NEW_FORM_TITLE' => 'New Booking',
    'LBL_PANEL_STIC_BOOKINGS_INFORMATION' => 'Overview',
    ...
    'LBL_STIC_BOOKINGS_STIC_PAYMENT_COMMITMENTS_FROM_STIC_PAYMENT_COMMITMENTS_TITLE' => 'Payment commitment',
    ...
    'LBL_RESOURCES_CODE' => 'Code',
    'LBL_RESOURCES_COLOR' => 'Color',
    'LBL_RESOURCES_HOURLY_RATE' => 'Hourly rate',
    'LBL_RESOURCES_DAILY_RATE' => 'Daily rate',
    'LBL_RESOURCES_CENTER' => 'Center',
    'LBL_RESOURCES_GENDER' => 'Place gender',
    ...
    'LBL_RESOURCES_PLANNED_END_DATE_ERROR' => 'Planned end date must be after Planned start date.',
    'LBL_RESOURCES_PLANNED_START_DATE_ERROR' => 'Planned start date must be before Planned end date.',
    'LBL_RESOURCES_EMPTY_RESOURCES_ERROR' => 'Check resources.',
    'LBL_RESOURCES_EMPTY_RESOURCES_ERROR_DIALOG' => 'This booking has no resources. Do you want to save it anyway?',
    'LBL_RESOURCES_TYPE_MIX_ERROR' => 'Cannot save the booking: check its type and the selected resources.',
    'LBL_CONFIRM_CHANGE_BOOKING_TYPE' => 'Changing the booking type will clear all currently selected resources. Do you want to continue?',
    'LBL_NO_NEW_RESOURCES' => 'There are no places to add.',
    'LBL_CONFIRM_DELETE_ALL_RESOURCES' => 'Do you want to delete all places included in the booking?',
    'LBL_NO_GROUPS_TO_DELETE' => 'There are no places to delete.',
    'LBL_CONFIRM_DELETE_LAST_GROUP' => 'Do you want to delete the last places added to the booking?',
    'LBL_RESOURCES_REMOVED_FROM_CENTER' => 'The places of the removed center will be deleted.',
    ...
    'LBL_CENTER_RESOURCE_ERROR' => 'Error while loading center places: ',
    'LBL_CENTERS_MESSAGE' => 'Places loaded: ',
    'LBL_UNDO_BUTTON' => 'Undo',
    'LBL_ADD_BUTTON' => 'Add',
    ...
    'LBL_REPEAT_OCCURRENCES' => 'bookings',
    ...
    'LBL_PERIODIC_BOOKINGS_SUMMARY_RECORDS_NOT_TO_CREATE' => 'Number of records not created',
    'LBL_PERIODIC_BOOKINGS_SUMMARY_RECORDS_NOT_TO_CREATE_TEXT' => 'Records have not been created due to overlapping with some other existing records of incompatible types. The following lists the uncreated records for the different users.',
    ...
    'LBL_RESOURCES_LIST' => 'Resources list',
