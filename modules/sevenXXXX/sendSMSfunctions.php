...
//     public function sendSMSwithText(?string $from, string $text, string $to, $bean): array {

//         $processedText = $this->sevenReplaceEmailVariables($text, $bean);


//         $to = preg_replace('~\D~', '', $to);
//         return $this->apiCall($this->getSender(), $processedText, $to);
//     }
