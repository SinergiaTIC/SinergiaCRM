...
array( 
    ...
    'campaign_name' => array(
        ...
        'source'=>'non-db',
                    ...
                    array('name' => 'stic_messages_manpk', 'type' => 'primary', 'fields' => array('id')),
                    array('name' => 'idx_smessman_list', 'type' => 'index', 'fields' => array('list_id','user_id','deleted')),
                    array('name' => 'idx_smessman_campaign_id', 'type' => 'index', 'fields' => array('campaign_id')),
                    array('name' => 'idx_smessman_relid_reltype_id', 'type' => 'index', 'fields'=> array('related_id', 'related_type', 'campaign_id')),
                    )
);
