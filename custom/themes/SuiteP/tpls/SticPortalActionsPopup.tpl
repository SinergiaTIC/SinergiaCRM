...
<div id="portalActionsPopup" class="pap-overlay">
    <div class="pap-dialog">
        ...
        <div class="pap-info">
            ...
            <strong>Requirements:</strong> The contact must have an email address. Configure apps in <a
                href="index.php?module=Administration&amp;action=sticportalconfig" target="_blank">Administration &rarr;
                Portal Configuration</a>.
        </div>
