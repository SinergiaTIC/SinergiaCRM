...
h1{font-size:18px;margin-bottom:20px;text-align:center}.msg{padding:10px;border-radius:4px;margin-bottom:15px;font-size:13px}
...
input[type="text"]{width:100%;padding:10px 12px;border:1px solid #ddd;border-radius:4px;font-size:14px;margin-bottom:15px}
...
</style></head><body><div class="card"><h1>Reset Password</h1>
{/literal}
