...
$dictionary["stic_custom_view_actions_stic_custom_view_customizations"] = array (
    'true_relationship_type' => 'one-to-many',
    'relationships' => 
    array (
      'stic_custom_view_actions_stic_custom_view_customizations' => 
      array (
        ...
        'rhs_key' => 'id',
        'relationship_type' => 'many-to-many',
        'join_table' => 'stic_custom_view_actions_stic_custom_view_customizations_c',
        'join_key_lhs' => 'stic_custod6f1zations_ida',
        'join_key_rhs' => 'stic_custo72cfactions_idb',
      ),
    ),
    'table' => 'stic_custom_view_actions_stic_custom_view_customizations_c',
    'fields' => 
    array (
      0 => 
      array (
      ...
      4 => 
      array (
        'name' => 'stic_custo72cfactions_idb',
        'type' => 'varchar',
        'len' => 36,
      ),
    ),
    ...
    array (
      0 => 
      array (
        'name' => 'stic_custom_view_actions_stic_custom_view_customizationsspk',
        'type' => 'primary',
        'fields' => 
        array (
          0 => 'id',
      ...
      1 => 
      array (
        'name' => 'stic_custom_view_actions_stic_custom_view_customizations_ida1',
        'type' => 'index',
        'fields' => 
        array (
          0 => 'stic_custod6f1zations_ida',
        ),
      ),
      2 => 
      array (
        'name' => 'stic_custom_view_actions_stic_custom_view_customizations_alt',
        'type' => 'alternate_key',
        'fields' => 
        array (
          0 => 'stic_custo72cfactions_idb',
        ),
      ),
    ),
);

$dictionary["stic_custom_view_conditions_stic_custom_view_customizations"] = array (
    'true_relationship_type' => 'one-to-many',
    'relationships' => 
    array (
      'stic_custom_view_conditions_stic_custom_view_customizations' => 
      array (
        'lhs_module' => 'stic_Custom_View_Customizations',
        'lhs_table' => 'stic_custom_view_customizations',
        'lhs_key' => 'id',
        ...
        'rhs_key' => 'id',
        'relationship_type' => 'many-to-many',
        'join_table' => 'stic_custom_view_conditions_stic_custom_view_customizations_c',
        'join_key_lhs' => 'stic_custo3a0dzations_ida',
        'join_key_rhs' => 'stic_custoec65ditions_idb',
      ),
    ),
    'table' => 'stic_custom_view_conditions_stic_custom_view_customizations_c',
    'fields' => 
    array (
      0 => 
      array (
      ...
      4 => 
      array (
        'name' => 'stic_custoec65ditions_idb',
        'type' => 'varchar',
        'len' => 36,
      ),
    ),
    ...
    array (
      0 => 
      array (
        'name' => 'stic_custom_view_conditions_stic_custom_view_customizationsspk',
        'type' => 'primary',
        'fields' => 
        array (
          0 => 'id',
      ...
      1 => 
      array (
        'name' => 'stic_custom_view_conditions_stic_custom_view_customizations_ida1',
        'type' => 'index',
        'fields' => 
        array (
          0 => 'stic_custo3a0dzations_ida',
        ),
      ),
      2 => 
      array (
        'name' => 'stic_custom_view_conditions_stic_custom_view_customizations_alt',
        'type' => 'alternate_key',
        'fields' => 
        array (
          0 => 'stic_custoec65ditions_idb',
        ),
      ),
    ),
);

$dictionary["stic_custom_view_customizations_stic_custom_views"] = array (
    'true_relationship_type' => 'one-to-many',
    'relationships' => 
    array (
      'stic_custom_view_customizations_stic_custom_views' => 
      array (
        ...
        'rhs_key' => 'id',
        'relationship_type' => 'many-to-many',
        'join_table' => 'stic_custom_view_customizations_stic_custom_views_c',
        'join_key_lhs' => 'stic_custo94b4m_views_ida',
        'join_key_rhs' => 'stic_custo86bdzations_idb',
      ),
    ),
    'table' => 'stic_custom_view_customizations_stic_custom_views_c',
    'fields' => 
    array (
      0 => 
      array (
      ...
      4 => 
      array (
        'name' => 'stic_custo86bdzations_idb',
        'type' => 'varchar',
        'len' => 36,
      ),
    ),
    ...
    array (
      0 => 
      array (
        'name' => 'stic_custom_view_customizations_stic_custom_viewsspk',
        'type' => 'primary',
        'fields' => 
        array (
          0 => 'id',
      ...
      1 => 
      array (
        'name' => 'stic_custom_view_customizations_stic_custom_views_ida1',
        'type' => 'index',
        'fields' => 
        array (
          0 => 'stic_custo94b4m_views_ida',
        ),
      ),
      2 => 
      array (
        'name' => 'stic_custom_view_customizations_stic_custom_views_alt',
        'type' => 'alternate_key',
        'fields' => 
        array (
          0 => 'stic_custo86bdzations_idb',
        ),
      ),
    ),
);
