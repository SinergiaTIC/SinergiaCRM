...
/** STIC - BFD - 02/2024 - Custom send email Actions for AOW **/

require_once 'modules/AOW_Actions/actions/actionBase.php';
require_once 'modules/AOW_WorkFlow/aow_utils.php';
class actionSticSendEmail extends actionBase
{
    ...
    public function run_action(SugarBean $bean, $params = array(), $in_save = false)
    {
        ...
        if (isset($params['individual_email']) && $params['individual_email']) {
            foreach ($emails['to'] as $email_to) {
                ...
                // if (!$this->sendEmail(array($email_to), $emailTemp->subject, $emailTemp->body_html, $emailTemp->body, $bean, $emails['cc'], $emails['bcc'], $attachments, $fromEmail, $fromName, $replyto)) {
