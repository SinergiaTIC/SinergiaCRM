...
class CustomAOS_InvoicesViewEdit extends AOS_InvoicesViewEdit
{
    ...
    public function display()
    {
        ...
        if (!AOS_InvoicesUtils::isVerifactuActivated()) {
            ...
            foreach (AOS_InvoicesUtils::getIssuedFamilyStatuses($app_list_strings['invoice_status_dom']) as $issuedStatus) {
        ...
        echo '<link rel="stylesheet" href="custom/modules/AOS_Invoices/css/editview.css?v=' . filemtime('custom/modules/AOS_Invoices/css/editview.css') . '">';
