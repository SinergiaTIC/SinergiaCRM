...
class CustomCalendarController extends CalendarController
{
    ...
    function action_SaveFilters()
    {
        ...
        $current_user->setPreference('calendar_stic_work_calendar_users_id', $_POST['stic_work_calendar_users_id']);
        $current_user->setPreference('calendar_stic_work_calendar_users_department', $_POST['stic_work_calendar_users_department']);
