...
$mod_strings['LBL_SDA_ALLOWED_INFO'] = 'Indica el nivel de acceso del usuario en Sinergia Data Analytics.<ul><li><b>Sin acceso</b>: el usuario no podrá acceder a Sinergia Data Analytics.</li><li><b>Acceso completo</b>: el usuario podrá crear, modificar y ejecutar informes en Sinergia Data Analytics.</li><li><b>Acceso de solo lectura</b>: el usuario podrá ejecutar informes y ver sus resultados pero no podrá crear informes nuevos ni modificar los existentes.</li></ul>';
