...
$mod_strings['LBL_SDA_ALLOWED_INFO'] = 'Indicates the level of access of the user in Sinergia Data Analytics.<ul><li><b>No access</b>: the user will not be able to access Sinergia Data Analytics.</li><li><b>Full access</b>: the user will be able to create, modify and run reports in Sinergia Data Analytics.</li><li><b>Read-only access</b>: the user will be able to run reports and see their results but will not be able to create new reports nor modify existing ones.</li></ul>';
