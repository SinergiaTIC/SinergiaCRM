...
$mod_strings['LBL_CERT_NOT_VALID_FOR_INSTANCE'] = 'Este certificado no es válido en esta instancia porque está vinculado a otra instancia/subdominio. Fue instalado en: %s. Para poder utilizarlo debe reinstalarlo desde Administración > Certificado Digital.';
$mod_strings['LBL_CERT_NO_INSTANCE_BINDING'] = 'Este certificado no está vinculado a ninguna instancia/subdominio. Para poder utilizarlo debe reinstalarlo desde Administración > Certificado Digital.';
...
$mod_strings['LBL_CUSTOMER_IDENTIFICATION_NUMBER_MISSING'] = 'La Organización o Persona seleccionada no tiene informado el NIF/DNI/CIF. Por favor, edite el cliente y complete este campo antes de enviar la factura.';
...
$mod_strings['LBL_VERIFACTU_QUERY_PERIOD_PLACEHOLDER'] = 'Selecciona un mes';
$mod_strings['LBL_VERIFACTU_QUERY_PERIOD_REQUIRED'] = 'Selecciona al menos un mes o un rango de fechas para realizar la consulta AEAT.';
