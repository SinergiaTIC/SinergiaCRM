...
$mod_strings['LBL_LIST_FORM_TITLE'] = 'Llista de Seccions de plantilla';
$mod_strings['LBL_MODULE_NAME'] = 'Seccions de plantilla';
$mod_strings['LBL_MODULE_TITLE'] = 'Seccions de plantilla';
$mod_strings['LBL_HOMEPAGE_TITLE'] = 'Les meves Seccions de plantilla';
$mod_strings['LNK_NEW_RECORD'] = 'Crea una Secció de plantilla';
$mod_strings['LNK_LIST'] = 'Mostra les Seccions de plantilla';
$mod_strings['LBL_SEARCH_FORM_TITLE'] = 'Cerca Seccions de plantilla';
$mod_strings['LBL_STIC_PANEL_RECORD_DETAILS'] = 'Detalls del registre';

$mod_strings['LBL_HTMLCODE'] = 'Codi HTML';
$mod_strings['LBL_THUMBNAIL_IMAGE'] = 'Imatge en miniatura';
$mod_strings['LBL_THUMBNAIL_IMAGE_HELP'] = "Aquesta imatge es mostrarà al llistat de miniatures que apareix a l'esquerra de l'editor de plantilles Mozaik. Es pot pujar una imatge externa o crear-ne una automàticament prement el botó 'Crea una imatge'. Si se'n puja una d'externa, es recomana format PNG o JPG i unes dimensions de 225 x 50 píxels. Si es crea automàticament, s'hi mostrarà el text del camp 'Nom curt per a la miniatura'.";
$mod_strings['LBL_THUMBNAIL_IMAGE_CREATE_IMAGE_BUTTON'] = 'Crea una imatge';
$mod_strings['LBL_THUMBNAIL_IMAGE_CREATE_IMAGE_CONFIRM'] = 'Voleu substituir la imatge precarregada per la nova que es crearà?';
$mod_strings['LBL_THUMBNAIL_NAME'] = 'Nom curt per a la miniatura';
$mod_strings['LBL_THUMBNAIL_NAME_HELP'] = "El text d'aquest camp, limitat a 40 caràcters, es farà servir com a contingut de la miniatura creada automàticament.";
