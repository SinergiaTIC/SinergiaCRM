...
$mod_strings['LBL_STIC_CERTIFICATE_DESC'] = 'Gestión del certificado digital del sistema.';
$mod_strings['LBL_STIC_CERT_UPLOAD_TITLE'] = 'Gestionar Certificado Digital';
$mod_strings['LBL_STIC_CERT_INSTALL_TITLE'] = 'Instalar un certificado';
$mod_strings['LBL_STIC_CERT_CURRENT_STATUS'] = 'Certificado actual:';
$mod_strings['LBL_STIC_CERT_EXISTS'] = 'Existe un certificado instalado.';
$mod_strings['LBL_STIC_CERT_NOT_EXISTS'] = 'No hay certificado instalado.';
$mod_strings['LBL_STIC_CERT_FILE'] = 'Archivo del certificado:';
$mod_strings['LBL_STIC_CERT_FILE_HELP'] = 'Seleccione un archivo de certificado digital en formato PFX o P12.';
$mod_strings['LBL_STIC_CERT_PASSWORD'] = 'Contraseña del certificado:';
$mod_strings['LBL_STIC_CERT_PASSWORD_HELP'] = 'Introduzca la contraseña del certificado. Se verificará antes de instalarlo.';
$mod_strings['LBL_STIC_CERT_UPLOAD_BTN'] = 'Instalar Certificado';
$mod_strings['LBL_STIC_CERT_SUCCESS'] = 'Certificado instalado correctamente.';
$mod_strings['LBL_STIC_CERT_ERROR_UPLOAD'] = 'Error al subir el archivo.';
$mod_strings['LBL_STIC_CERT_ERROR_WRITE'] = 'Error al instalar el certificado.';
$mod_strings['LBL_STIC_CERT_ERROR_PASSWORD_REQUIRED'] = 'La contraseña del certificado es obligatoria.';
$mod_strings['LBL_STIC_CERT_ERROR_INVALID_PASSWORD'] = 'La contraseña del certificado es incorrecta o el archivo está corrupto.';
$mod_strings['LBL_STIC_CERT_UPLOAD_INFO'] = 'Información del certificado';
$mod_strings['LBL_STIC_CERT_FILENAME'] = 'Nombre del archivo';
$mod_strings['LBL_STIC_CERT_UPLOAD_DATE'] = 'Fecha de instalación';
$mod_strings['LBL_STIC_CERT_UPLOADED_BY'] = 'Instalado por';
$mod_strings['LBL_STIC_CERT_SUBJECT'] = 'Titular';
$mod_strings['LBL_STIC_CERT_ISSUER'] = 'Emisor';
$mod_strings['LBL_STIC_CERT_VALID_FROM'] = 'Válido desde';
$mod_strings['LBL_STIC_CERT_VALID_TO'] = 'Válido hasta';
$mod_strings['LBL_STIC_CERT_SERIAL'] = 'Número de serie';
$mod_strings['LBL_STIC_CERT_EXTRACTED_DATA'] = 'Datos del certificado';
$mod_strings['LBL_STIC_CERT_EXTRACTED_NIF'] = 'NIF/CIF';
$mod_strings['LBL_STIC_CERT_EXTRACTED_NAME'] = 'Nombre del titular';
$mod_strings['LBL_STIC_CERT_EXTRACTED_TYPE'] = 'Tipo de certificado';
$mod_strings['LBL_STIC_CERT_TYPE_ENTITY_SEAL'] = 'Sello de entidad';
$mod_strings['LBL_STIC_CERT_TYPE_REPRESENTATIVE'] = 'Personal/Representante';
...
$mod_strings['LBL_AOS_INVOICE_SERIES_FORMAT_VALIDATION'] = 'Solo mayúsculas (A-Z), números (0-9) y símbolos (- _ / .). No se permiten números del 1-9.';
$mod_strings['LBL_AOS_INVOICE_SERIES_INITIAL_VALIDATION'] = 'El número inicial debe ser 1 o superior';
$mod_strings['LBL_AOS_INVOICE_SERIES_FORMAT_ERROR'] = 'El formato \'{0}\' contiene números del 1-9, que no están permitidos en el formato. Use solo 0 (cero) para el número secuencial.';
$mod_strings['LBL_AOS_INVOICE_SERIES_REMOVE_CONFIRM'] = '¿Está seguro de que desea eliminar esta serie?';
$mod_strings['LBL_AOS_INVOICE_SERIES_REMOVE_BLOCKED'] = 'No se puede eliminar la serie porque tiene facturas aceptadas por la AEAT.';
$mod_strings['LBL_AOS_INVOICE_SERIES_BLOCKED_TOOLTIP'] = 'Esta serie no puede modificarse porque tiene facturas aceptadas en el año actual.';
