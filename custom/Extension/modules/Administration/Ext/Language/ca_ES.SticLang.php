...
$mod_strings['LBL_OAUTH_AUTH_ENABLE_HELP'] = "Si activeu aquesta opció, els usuaris podran autenticar-se mitjançant OAuth 2.0, a més de fer-ho amb usuari i contrasenya. Després d'activar aquesta opció s'haura de configurar, com a mínim, un dels proveïdors extens. Per a més informació, consulteu la <a href='https://docs.sinergiacrm.org/en/latest/administering/system-configuration/oauth-authentication.html' target='_blank'>documentació</a>.";
