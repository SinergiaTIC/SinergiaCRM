...
$mod_strings['LBL_STIC_SINERGIADA_URL_HELP'] = "URL on es troba la instància de SinergiaDA. Es fa servir per enllaçar-la i per construir la crida a updateModel. Si no s'indica, s'assumeix que es tracta d'una instal·lació estàndard als servidors de SinergiaTIC.";
$mod_strings['LBL_STIC_SINERGIADA_SEED_STRING_LABEL'] = "Cadena d'encriptació";
$mod_strings['LBL_STIC_SINERGIADA_SEED_STRING_HELP'] = 'Cadena aleatòria emprada per SinergiaDA per encriptar valors a la base de dades i assegurar la crida a updateModel.';
