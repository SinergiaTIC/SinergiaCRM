...
$mod_strings["LBL_STIC_PORTAL_APPS"] = "Portal Apps";
$mod_strings["LBL_STIC_PORTAL_APP_NAME"] = "App Name";
$mod_strings["LBL_STIC_PORTAL_APP_URL"] = "App URL (redirect_uri)";
$mod_strings["LBL_STIC_PORTAL_ADD_APP"] = "Add App";
$mod_strings["LBL_STIC_PORTAL_DELETE"] = "Delete";
$mod_strings["LBL_STIC_PORTAL_NO_APPS"] = "No apps configured. Click Add below.";
$mod_strings["LBL_STIC_PORTAL_APPS_HELP"] = "Configure external apps that will appear as invitation options on Contact and Account detail views. Each app needs a name and its redirect URL (callback URL). When an invitation is sent, the reset link will redirect back to the selected app after password setup.";
$mod_strings["LBL_STIC_PORTAL_ACTIONS"] = "Portal Actions";
$mod_strings["LBL_STIC_PORTAL_APPLY_TAB"] = "Apply Portal Tab to Contacts";
$mod_strings["LBL_STIC_PORTAL_APPLY_TAB_HELP"] = "Adds the Portal Authentication tab to all Contacts\x27 DetailView and EditView. Use this when Contacts were created before the portal feature was installed and are missing the portal fields tab.";
