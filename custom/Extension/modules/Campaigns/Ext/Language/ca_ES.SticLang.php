...
$mod_strings['LBL_LEAD_DEFAULT_HEADER'] = 'Formulari web a interessat per a la Campanya';
$mod_strings['LBL_LEAD_FORM_WIZARD'] = 'Assistent de Formularis per a Interessats';
...
$mod_strings['LBL_NOTIFICATION_AUTO_PROSPECT_LIST_NAME'] = 'Envia una notificació a:';
...
$mod_strings['LBL_NOTIFICATION_AUTO_PROSPECT_LIST_NAME_HELP'] = "Es crearà automàticament una llista de públic objectiu d'acord amb l'opció seleccionada i s'afegirà a la notificació.";
$mod_strings['LBL_NOTIFICATION_AUTO_PROSPECT_LIST_ERROR'] = "S'ha produït un error al crear la llista de públic objectiu.";
