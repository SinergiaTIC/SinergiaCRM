...
$mod_strings['LBL_STIC_SECURITY_GROUPS_RULES_ENABLED'] = 'Habilitar reglas personalizadas de herencia de Grupos de Seguridad por módulos.';
$mod_strings['LBL_STIC_SECURITY_GROUPS_RULES_ENABLED_INFO'] = 'Si se habilitan las reglas de herencia de Grupos de Seguridad por módulos, las reglas definidas y activadas para cada módulo tendrán preferencia sobre las reglas de herencia definidas aquí.';
