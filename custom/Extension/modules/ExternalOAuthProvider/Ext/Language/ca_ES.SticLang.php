...
$mod_strings['LBL_AUTHORIZE_URL_OPTIONS_HELP'] = "En aquest camp cal indicar-hi els paràmetres addicionals de configuració depenents de cada proveïdor que s'afegiran a la URL d'autorització per poder realitzar el procés d'autenticació i autorització.";
$mod_strings['LBL_URL_ACCESS_TOKEN_HELP'] = "En aquest camp cal indicar-hi la URL a la qual SinergiaCRM envia el codi d'autorització obtingut amb la URL d'autorització per obtenir els tokens d'accés i de refresc.";
...
$mod_strings['LBL_EXTRA_PROVIDER_PARAMS_HELP'] = "En aquest camp s'hi poden indicar els paràmetres addicionals depenents de cada proveïdor i que seran aplicats en diferents fases del procés: autenticació i autorització, obtenció de tokens, etc.";
