...
$mod_strings['LBL_AUTHORIZE_URL_OPTIONS_HELP'] = "En aquest camp es poden indicar paràmetres que seran afegits a la URL d'autorització i que serveixen per personalitzar l'experiència d'usuari durant el procés d'autenticació i autorització amb el proveïdor de correu. Per exemple: 'access_type=offline' sol·licita un token de refresc per a accés sense connexió, 'prompt=consent' força el proveïdor a mostrar la pantalla de permisos encara que ja s'hagin concedit, etc.";
...
$mod_strings['LBL_EXTRA_PROVIDER_PARAMS_HELP'] = "En aquest camp es poden indicar paràmetres addicionals (URLs o dades) requerits pel proveïdor per completar el procés d'autenticació, perquè SinergiaCRM pugui recuperar informació de l'usuari una vegada està autenticat. etc. Per exemple, 'urlResourceOwnerDetails=><url_informació_usuari>' defineix l'URL on SinergiaCRM pot connectar-se per obtenir informació de l'usuari un cop estigui autenticat.';
