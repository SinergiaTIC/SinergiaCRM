...
$mod_strings['LBL_AUTHORIZE_URL_OPTIONS_HELP'] = 'En este campo pueden indicarse parámetros que serán añadidos a la URL de autorización y que sirven para personalizar la experiencia de usuario durante el proceso de autenticación y autorización con el proveedor de correo. Por ejemplo: "access_type=offline" solicita un token de refresco para acceso sin conexión, "prompt=consent" fuerza al proveedor a mostrar la pantalla de permisos aunque ya se hayan concedido, etc.';
...
$mod_strings['LBL_EXTRA_PROVIDER_PARAMS_HELP'] = 'En este campo pueden indicarse parámetros adicionales (URLs o datos) requeridos por el proveedor para completar el proceso de autenticación, para que SinergiaCRM pueda recuperar información del usuario una vez está autenticado. etc. Por ejemplo "urlResourceOwnerDetails=><url_información_usuario>" define la URL donde SinergiaCRM puede conectarse para obtener información del usuario una vez esté autenticado.';
