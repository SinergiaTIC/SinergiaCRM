...
$mod_strings['LBL_AUTHORIZE_URL_OPTIONS_HELP'] = 'En este campo pueden indicarse los parámetros adicionales de configuración dependedientes de cada proveedor que se añadirán a la URL de autorización para poder realizar el proceso de autenticación y autorización.';
...
$mod_strings['LBL_EXTRA_PROVIDER_PARAMS_HELP'] = 'En este campo pueden indicarse parámetros adicionales dependientes de cada proveedor y que serán usados en diferentes fases del proceso: autenticación y autorización, obtención de tokens, etc.';
