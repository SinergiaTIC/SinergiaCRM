...
$mod_strings['LBL_EXTRA_PROVIDER_PARAMS_HELP'] = 'In this field you can indicate additional parameters (URLs or data) required by the provider to complete the authentication process, so that SinergiaCRM can retrieve user information once authenticated. etc. For example "urlResourceOwnerDetails=><url_information_user>" defines the URL where SinergiaCRM can connect to obtain user information once authenticated.';
