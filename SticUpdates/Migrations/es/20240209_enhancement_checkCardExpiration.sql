...
('b9755f82-72c9-d361-10b7-5b40699f14c4', NOW(), NOW(), '1', '1', 0, '1', 'TPV', 'TPV_MESES_CADUCIDAD', '0', 'Indica los meses de antelación con los que avisar del vencimiento de tarjetas (0 - mes actual, 1 - mes siguiente, -1 - no avisar).');
