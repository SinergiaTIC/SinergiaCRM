...
('96c34b2d-d499-11ef-af33-0242ac120003', 0, NOW(), NOW(), '1', '1', 'SinergiaCRM - Scheduled Send Messages to phone', 'function::sticSendPhoneMessages', NOW(), NULL, '*::2-6::*::*::*', NULL, NULL, NULL, 'Active', 0);
...
('e5a26eec-b326-11f0-b8b0-f2de65fe24cb', NOW(), NOW(), '1', '1', 0, '1', 'SEVEN', 'SEVEN_MESSAGES_BULK', '5000', "Max number of messages sent per hour when sending campaigns.");
