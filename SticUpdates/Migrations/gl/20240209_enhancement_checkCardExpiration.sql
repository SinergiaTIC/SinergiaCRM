...
('b9755f82-72c9-d361-10b7-5b40699f14c4', NOW(), NOW(), '1', '1', 0, '1', 'TPV', 'TPV_MESES_CADUCIDAD', '0', 'Indica el mes de vencimiento de las tarjetas a revisar (0 = Mes actual, 1 = Mes siguiente, -1 = No avisar).');
