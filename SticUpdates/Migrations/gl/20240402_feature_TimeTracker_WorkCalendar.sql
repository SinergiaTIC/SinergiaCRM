...
('56dca334-679c-266d-fd9a-660bcd6ed93e', 0, NOW(), NOW(), '1', '1', 'SinergiaCRM - Validación y actualización semanal de datos', 'function::validationActions', NOW(), NULL, '*::1::*::*::1', NULL, NULL, NULL, 'Inactive', 0);
...
('78e895d4-b528-7392-5e83-66347f276649', NOW(), NOW(), '1', '1', 0, '1', 'TIMETRACKER', 'TIMETRACKER_LOWER_MARGIN_PERCENT', '20', 'Indica el margen inferior de diferencia que puede haber entre las horas que el empleado debía trabajar esa semana y las horas trabajadas.  Este margen está relacionado con la acción de validación: Comprobar la cantidad de horas trabajadas por cada empleado durante la semana anterior.  En caso de que la diferencia en horas supere este margen, la acción de validación deberá avisar de un posible error.'),
('6ac2d1e7-ff90-61f0-85c2-66347f0d8311', NOW(), NOW(), '1', '1', 0, '1', 'TIMETRACKER', 'TIMETRACKER_UPPER_MARGIN_PERCENT', '20', 'Indica el margen superior de diferencia que puede haber entre las horas que el empleado debía trabajar esa semana y las horas trabajadas.  Este margen está relacionado con la acción de validación: Comprobar la cantidad de horas trabajadas por cada empleado durante la semana anterior.  En caso de que la diferencia en horas supere este margen, la acción de validación deberá avisar de un posible error.');
