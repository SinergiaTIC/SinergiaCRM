...
-- Updated: 2026-09-09 — Uses REPLACE INTO (idempotent upsert, no DELETE+INSERT)

-- Default portal title (language-dependent string)
REPLACE INTO config (category, name, value) VALUES ('portal', 'PORTAL_TITLE', 'SinergiaCRM Portal');
...
REPLACE INTO config (category, name, value) VALUES ('portal', 'PORTAL_INVITATION_LIMIT', '100');
