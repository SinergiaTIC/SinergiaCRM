...
$contact_user_link_guid',
    ...
    'LBL_WIZARD_SMTP_DESC' => 'Indiqueu el compte de correu electrònic que s\'utilitzarà per enviar correus electrònics, com les notificacions d\'assignació i les contrasenyes dels nous usuaris. Els usuaris rebran correus de SuiteCRM com si haguesin estat enviats des del compte de correu especificat.',
    ...
    'LBL_ALLOW_DEFAULT_SELECTION' => 'Permet als usuaris utilitzar aquest compte per al correu electrònic sortint:',
    'LBL_ALLOW_DEFAULT_SELECTION_HELP' => 'Quan aquesta opció està seleccionada, tots els usuaris podran enviar correus electrònics utilitzant el mateix compte de correu de sortida per a l\'enviament de notificacions del sistema i avisos. Si l\'opció no està seleccionada, els usuaris poden utilitzar el servidor de correu de sortida després de proporcionar la informació del seu compte.',
    ...
    'LBL_WIZARD_LOCALE_DESC' => 'Especifiqueu com voleu que siguin mostrades les dades a SuiteCRM, basant-se en la ubicació geogràfica. La configuració que proporcioneu aquí serà utilitzada per defecte. Els usuaris podran establir les seves pròpies preferències.',
    ...
    'UPLOAD_LOGO' => 'Espereu mentre es puja el logotip...',
    'ERR_UPLOAD_FILETYPE' => 'Tipus de fitxer no permès. Pugeu un fitxer de format jpg o png.',
    ...
    'ERR_UPLOAD_FILE_UPLOAD_ERR_EXTENSION' => 'Una extensió de PHP ha aturat la pujada del fitxer. PHP no ofereix mitjans per conèixer la raó que ha provocat aquest fet.',
    ...
    'ERR_SITE_URL' => "L'adreça URL del lloc és obligatòria.",
    ...
    'STAT_INSTALL_FINISH_LOGIN' => 'Ha finalitzat el procés d\'instal·lació, <a href="%s">identifiqueu-vos...</a>',
    'LBL_LICENCE_TOOLTIP' => 'Accepteu primer la llicència',

    'LBL_MORE_OPTIONS_TITLE' => 'Més opcions',
    'LBL_START' => 'Iniciar',
    'LBL_DB_CONN_ERR' => 'Error a la base de dades',
    'LBL_OLD_PHP' => "S'ha detectat una versió antiga de PHP!",
    'LBL_OLD_PHP_MSG' => "La versió de PHP recomanada per instal·lar SuiteCRM és %s.<br />La versió mínima de PHP requerida és %s.<br />Actualment s'està fent servir la versió %s de PHP, que ha arribat al final del seu cicle de vida: <a href='https://php.net/eol.php'>https://php.net/eol.php</a>.<br />Considereu actualitzar la versió de PHP.",
    'LBL_OLD_PHP_OK' => 'Soc conscient dels riscos i vull continuar.',

    'LBL_DBCONF_TITLE_USER_INFO_LABEL' => 'Usuari',
    'LBL_DBCONFIG_MSG3_LABEL' => 'Nom de la base de dades',
    'LBL_DBCONFIG_MSG3' => 'Nom de la base de dades que acollirà les dades de la instància de SuiteCRM que instal·larà:',
    'LBL_DBCONFIG_MSG2_LABEL' => 'Nom del servidor',
    'LBL_DBCONFIG_MSG2' => 'Nom del servidor web o màquina (amfitrió) on hi ha la base de dades (per exemple www.mydomain.com). Si s\'instal·la localment, és millor utilitzar \'localhost\' que "127.0.0.1", per raons de rendiment.',
    'LBL_DBCONFIG_B_MSG1_LABEL' => '', // this label dynamically needed in install/installConfig.php:293
    'LBL_DBCONFIG_B_MSG1' => "Per configurar la base de dades de SuiteCRM calen el nom d'usuari i la contrasenya d'un administrador de bases de dades que pugui crear-hi taules i usuaris i que pugui escriure-hi."
);
