...
{if $SUCCESS}
  <div class="msg msg-success">Password changed successfully. <a href="index.php?entryPoint=sticPortalLogin">Log in</a>.</div>
{else}
  <div class="help">Minimum 8 characters. Additional requirements may apply based on security policy.</div>
  <form method="post">
