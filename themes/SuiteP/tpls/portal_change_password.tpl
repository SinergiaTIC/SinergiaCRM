{literal}
<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Change Password</title>
<style>
...
</style></head><body><div class="card"><h1>Change Password</h1>
{/literal}
...
{else}
  ...
  <form method="post">
    ...
    <label>Confirm New Password</label><input type="password" name="confirm_password" required autocomplete="new-password">
