...
(function ($) {
  $.fn.MessagesComposeViewModal = function (options) {
    "use strict";
    var self = this;
    var opts = $.extend({}, $.fn.MessagesComposeViewModal.defaults, options);

    self.handleClick = function (e) {
      "use strict";
      var self = this;
      self.emailComposeView = null;
      var opts = $.extend({}, $.fn.MessagesComposeViewModal.defaults);
      ...
      $.ajax({
        ...
        self.emailComposeView = composeBox.controls.modal.body.find('.compose-view').MessagesComposeView();
  ...
  $.fn.openComposeMessageViewModal = function (source) {
    "use strict";
debugger;
    ...
    // var url = 'index.php?module=stic_Messages&action=ComposeView&in_popup=1&targetModule=' + targetModule + ids + '&relatedModule=' + currentModule + '&relatedId=' + relatedId;
    var url = 'index.php?module=stic_Messages&return_module='+currentModule+'&return_action=DetailView&return_id='+relatedId+'&action=ComposeView&in_popup=1&targetModule=' + targetModule + ids + '&relatedModule=' + currentModule + '&relatedId=' + relatedId;
    $.ajax({
      type: "GET",
      cache: false,
      url: url
      ...
      $(self.emailComposeView).find('#phone').val(dataPhone);
  ...
  $.fn.MessagesComposeViewModal.defaults = {
    'selected': 'INBOX',
