...
$app_list_strings = array(
    ...
    'moduleList' => array(
        ...
        'Notes' => 'Notes',
        'Calls' => 'Trucades',
        'TemplateSectionLine' => 'Seccions de plantilla',
...
$app_strings = array(
    ...
    'LBL_EMAIL_REMOVE_SMTP_WARNING' => 'Avís! El compte de sortida que esteu intentant eliminar està associat a un compte d\'entrada actual. Segur que voleu continuar?',
    ...
    'LBL_EMAIL_ARCHIVE_TO_SUITE' => 'Importa a SuiteCRM',
    ...
    'LBL_EMAIL_CHECK' => 'Comprova el correu',
    'LBL_EMAIL_CHECKING_NEW' => 'Comprovant nous correus electrònics',
    'LBL_EMAIL_CHECKING_DESC' => 'Un moment, si us plau... <br><br>Si és la primera comprovació per aquest compte de correu, pot tardar una estona.',
    'LBL_EMAIL_CLOSE' => 'Tanca',
    ...
    'LBL_EMAIL_COMPOSE_NO_BODY' => 'El cos d\'aquest missatge és buit. El voleu enviar igualment?',
    'LBL_EMAIL_COMPOSE_NO_SUBJECT' => 'Aquest missatge no té assumpte. El voleu enviar igualment?',
    'LBL_EMAIL_COMPOSE_NO_SUBJECT_LITERAL' => '(sense assumpte)',
    'LBL_EMAIL_COMPOSE_INVALID_ADDRESS' => 'Introduïu una adreça de correu electrònic vàlida per als camps: Per a, CC i CCO',

    'LBL_EMAIL_CONFIRM_CLOSE' => 'Segur que voleu descartar aquest correu electrònic?',
    'LBL_EMAIL_CONFIRM_DELETE_SIGNATURE' => 'Segur que voleu eliminar aquesta firma?',

    'LBL_EMAIL_SENT_SUCCESS' => 'Correu electrònic enviat',

    'LBL_EMAIL_CREATE_NEW' => '--Crea al desar--',
    ...
    'LBL_EMAIL_EMPTYING_TRASH' => 'Buidant la paperera',
    ...
    'LBL_EMAIL_FOLDERS_DELETE_CONFIRM' => 'Segur que voleu eliminar aquesta carpeta?\nAquest procés no es pot desfer.\nL\'eliminació de carpetes s\'aplicarà en cascada a totes les carpetes contingudes.',
    'LBL_EMAIL_FOLDERS_NEW_FOLDER' => 'Nom de la nova carpeta',
    'LBL_EMAIL_FOLDERS_NO_VALID_NODE' => 'Seleccioneu una carpeta abans de realitzar aquesta acció.',
    'LBL_EMAIL_FOLDERS_TITLE' => 'Administració de carpetes de SuiteCRM',

    'LBL_EMAIL_FORWARD' => 'Reenvia',
    'LBL_EMAIL_DELIMITER' => '::;::',
    ...
    'LBL_EMAIL_SAVE' => 'Desa',
    'LBL_EMAIL_SAVE_AND_REPLY' => 'Desa i respon',
    'LBL_EMAIL_SAVE_DRAFT' => "Desa l'esborrany",
    'LBL_EMAIL_DRAFT_SAVED' => 'L\'esborrany s\'ha desat correctament',

    'LBL_EMAIL_SEARCH' => SugarThemeRegistry::current()->getImage('Search', 'align=absmiddle border=0', null, null, '.gif', ''),
    'LBL_EMAIL_SEARCH_SHORT' => SugarThemeRegistry::current()->getImage('Search', 'align=absmiddle border=0', null, null, '.gif', ''),
    'LBL_EMAIL_SEARCH_DATE_FROM' => 'Des de',
    'LBL_EMAIL_SEARCH_DATE_UNTIL' => 'Fins a',
    'LBL_EMAIL_SEARCH_NO_RESULTS' => 'No hi ha resultats pels criteris de cerca indicats.',
    'LBL_EMAIL_SEARCH_RESULTS_TITLE' => 'Resultats de la cerca',

    'LBL_EMAIL_SELECT' => 'Selecciona',

    'LBL_EMAIL_SEND' => 'Envia',
    'LBL_EMAIL_SENDING_EMAIL' => 'Enviant el correu electrònic',

    'LBL_EMAIL_SETTINGS' => 'Configuració',
    'LBL_EMAIL_SETTINGS_ACCOUNTS' => 'Comptes de correu',
    'LBL_EMAIL_SETTINGS_ADD_ACCOUNT' => 'Neteja el formulari',
    'LBL_EMAIL_SETTINGS_CHECK_INTERVAL' => 'Comprova el correu',
    'LBL_EMAIL_SETTINGS_FROM_ADDR' => 'Adreça del remitent',
    'LBL_EMAIL_SETTINGS_FROM_TO_EMAIL_ADDR' => 'Adreça de correu electrònic per a la notificació de prova:',
    'LBL_EMAIL_SETTINGS_FROM_NAME' => 'Nom del remitent',
    'LBL_EMAIL_SETTINGS_REPLY_TO_ADDR' => 'Respon a l\'adreça',
    'LBL_EMAIL_SETTINGS_FULL_SYNC' => 'Sincronitza tots els comptes de correu',
    'LBL_EMAIL_TEST_NOTIFICATION_SENT' => 'S\'ha enviat un correu electrònic a l\'adreça indicada utilitzant la configuració de correu sortint. Comproveu si s\'ha rebut per verificar que la configuració és correcta.',
    'LBL_EMAIL_TEST_SEE_FULL_SMTP_LOG' => 'Vegeu el registre complet de l\'SMTP ',
    'LBL_EMAIL_SETTINGS_FULL_SYNC_WARN' => 'Voleu fer una sincronització completa?\nPer a comptes de correu grans pot durar diversos minuts.',
    'LBL_EMAIL_SUBSCRIPTION_FOLDER_HELP' => 'Feu servir les tecles Majúscules o Ctrl per seleccionar diverses carpetes.',
    'LBL_EMAIL_SETTINGS_GENERAL' => 'General',
    'LBL_EMAIL_SETTINGS_GROUP_FOLDERS_CREATE' => 'Crea Carpetes de Grup',

    'LBL_EMAIL_SETTINGS_GROUP_FOLDERS_EDIT' => 'Edita Carpetes de Grup',
    ...
    'LBL_EMAIL_SETTINGS_RETRIEVING_ACCOUNT' => 'Recuperant el compte de correu',
    'LBL_EMAIL_SETTINGS_SAVED' => 'S\'ha aplicat la configuració correctament.',
    'LBL_EMAIL_SETTINGS_SEND_EMAIL_AS' => 'Envia només correus electrònics de text pla',
    ...
    'LBL_EMAIL_INVALID_PERSONAL_OUTBOUND' => 'El servidor de correu sortint seleccionat per al compte de correu que utilitzeu no és vàlid. Comproveu-ne la configuració o seleccioneu un servidor de correu diferent.',
    ...
    'LBL_EMAIL_TEMPLATE_EDIT_PLAIN_TEXT' => 'El cos de la plantilla de correu electrònic és buit',
    'LBL_EMAIL_TEMPLATES' => 'Plantilles',
    'LBL_EMAIL_TO' => 'Per a',
    'LBL_EMAIL_VIEW' => 'Veure',
    'LBL_EMAIL_VIEW_HEADERS' => 'Mostra les capçaleres',
    'LBL_EMAIL_VIEW_RAW' => 'Mostra el codi font',
    ...
    'LBL_EMAIL_IMPORT_FAIL' => 'La importació ha fallat perquè el missatge ja ha estat importat o eliminat del servidor.',
    ...
    'ERR_AJAX_LOAD' => 'Ha succeït un error:',
    ...
    'ERR_NOTHING_SELECTED' => 'Feu una selecció abans de procedir.',
    ...
    'ERR_ADDRESS_KEY_NOT_SPECIFIED' => 'Especifiqueu l\'índex \'clau\' en l\'atribut displayParams per a la definició de Metadades',
    ...
    'LBL_CITY' => 'Ciutat',
    'LBL_CLEAR_BUTTON_LABEL' => 'Neteja',
    'LBL_CLEAR_BUTTON_TITLE' => 'Neteja',
    'LBL_CLEARALL' => "Desmarca'ls tots",
    'LBL_CLOSE_BUTTON_TITLE' => 'Tanca', // As in closing a task
    'LBL_CLOSE_AND_CREATE_BUTTON_LABEL' => "Tanca i crea'n un de nou", // As in closing a task
    'LBL_CLOSE_AND_CREATE_BUTTON_TITLE' => "Tanca i crea'n un de nou", // As in closing a task
    ...
    'LBL_LIST_CONTACT_ROLE' => 'Rol del contacte',
    ...
    'LBL_LISTVIEW_NO_SELECTED' => 'Seleccioneu almenys un registre per procedir.',
    'LBL_LISTVIEW_TWO_REQUIRED' => 'Seleccioneu almenys 2 registres per procedir.',
    ...
    'LBL_LOCALE_NAME_EXAMPLE_LAST' => 'Peris',
    ...
    'LBL_MEETING_GO_BACK' => 'Torna a la reunió',
    'LBL_MEMBERS' => 'Membres',
    ...
    'LNK_SEARCH_NONFTS_VIEW_ALL' => 'Mostra-ho tot',
    'LNK_CLOSE' => 'Tancament',
    'LBL_MODIFY_CURRENT_FILTER' => 'Modifica el filtre actual',
    'LNK_SAVED_VIEWS' => 'Cerques i dissenys desats',
    'LNK_DELETE' => 'Elimina',
    'LNK_EDIT' => 'Edita',
    ...
    'LNK_LIST_RETURN' => 'Torna a la llista',
    'LNK_LIST_START' => 'Inici',
    'LNK_LOAD_SIGNED' => 'Firma',
    'LNK_LOAD_SIGNED_TOOLTIP' => 'Substitueix amb el document firmat',
    'LNK_PRINT' => 'Imprimeix',
    'LNK_BACKTOTOP' => "Torna a l'inici",
    'LNK_REMOVE' => 'Elimina',
    'LNK_RESUME' => 'Continua',
    'LNK_VIEW_CHANGE_LOG' => 'Mostra el Registre de Canvis',

    'NTC_CLICK_BACK' => "Feu clic al botó per tornar enrere del navegador i corregiu l'error.",
    'NTC_DATE_FORMAT' => '(aaaa-mm-dd)',
    'NTC_DELETE_CONFIRMATION_MULTIPLE' => 'Segur que voleu eliminar els registres seleccionats?',
    'NTC_TEMPLATE_IS_USED' => 'La plantilla s\'està fent servir almenys en un registre de correu electrònic de màrqueting. Segur que voleu eliminar-la?',
    'NTC_TEMPLATES_IS_USED' => 'Les següents plantilles s\'estan fent servir en registres de correu electrònic de màrqueting. Segur que voleu eliminar-les?' . PHP_EOL,
    ...
    'NTC_REMOVE_CONFIRMATION' => "Segur que voleu desvincular els registres? Tingueu en compte que només s'esborrarà la relació entre ells però els registres seguiran existint als mòduls respectius i algun d'ells podria quedar orfe d'algun valor necessari. Si el que realment us cal és eliminar completament un registre, cancel·leu aquesta acció, obriu el registre a la seva vista de detall i esborreu-lo mitjançant l'acció corresponent del menú d'accions.",
    'NTC_REQUIRED' => 'Indica un camp requerit',
    'NTC_TIME_FORMAT' => '(24:00)',
    'NTC_WELCOME' => 'Benvingut',
    'NTC_YEAR_FORMAT' => '(aaaa)',
    'WARN_UNSAVED_CHANGES' => 'Esteu a punt d\'abandonar aquest registre sense desar els canvis que hagueu pogut fer-hi. Segur que voleu sortir d\'aquest registre?',
    ...
    'WARN_BROWSER_IE_COMPATIBILITY_MODE_WARNING' => '<b>Atenció:</b> El vostre navegador està en mode vista compatible IE. Aquest mode no és compatible.',
    ...
    'MSG_JS_ALERT_MTG_REMINDER_CALL_MSG' => "\nFeu clic a Accepta per veure aquesta trucada o a Cancel·la per tancar aquest missatge.",
    'MSG_JS_ALERT_MTG_REMINDER_MEETING_MSG' => "\nFeu clic a Accepta per veure aquesta reunió o a Cancel·la per tancar aquest missatge.",
...
"Aquest és un fitxer d\'importació d\'exemple que proporciona un exemple dels continguts que s\'esperava d\'un arxiu que està a punt per a la importació". "L\'arxiu és un fitxer CSV delimitat per comes, utilitzant cometes com el qualificador de camp". "La fila de capçalera és la fila més superior a l\'arxiu i conté les etiquetes de camp com vols veure-los en l\'aplicació". "Aquestes etiquetes s\'utilitzen per assignar les dades a l\'arxiu als camps en l\'aplicació." "Notes: els noms de la base de dades també podria ser utilitzat en la fila de capçalera. Això és útil quan està utilitzant phpMyAdmin o una altra eina de base de dades per proporcionar una llista de dades per importar exportat." "L\'ordre de columna no és crítica en el procés d\'importació coincideix amb les dades en els camps apropiats basats en la fila de capçalera". "Per utilitzar aquest fitxer com a plantilla, feu el següent:" "1. eliminar les files Mostra de dades" "2. Treure el text d\'ajuda que estàs llegint ara mateix""3. Aportació de les seves dades en el corresponents files i columnes""4. Salvi l\'arxiu a un lloc conegut en el seu sistema""5. Feu clic a l\'opció importa del menú accions en l\'aplicació i seleccioneu el fitxer per carregar"   ',
    ...
    'LBL_SUBTHEMES' => 'Estil',
    'LBL_SUBTHEME_OPTIONS_DAWN' => 'Albada',
...
$app_list_strings['countries_dom'] = array(
    ...
    'CHANNEL ISLAND UK' => 'Illes del Canal',
    'PACIFIC ISLAND' => 'Illes del Pacífic',
    'US PACIFIC ISLAND' => 'Illes del Pacífic (EUA)',
    'INDIA' => 'Índia',
    'WEST INDIES' => 'Índies Occidentals',
    'BRITISH WEST INDIES' => 'Índies Occidentals Britàniques',
    'INDONESIA' => 'Indonèsia',
    'IRAN' => 'Iran',
    'IRAQ' => 'Iraq',
    'IRELAND' => 'Irlanda',
    ...
    'NETHERLANDS ANTILLES NEUTRAL ZONE' => 'Zona Neutral de les Antilles Neerlandeses',
);
...
$app_list_strings['timezone_dom'] = array(
    ...
    'Africa/Addis_Ababa' => 'Àfrica/Addis Abeba',
    'Africa/Algiers' => 'Àfrica/Alger',
    'Africa/Asmera' => 'Àfrica/Asmara',
    ...
    'Africa/Sao_Tome' => 'Àfrica/São Tomé',
    ...
    'America/Mexico_City' => 'Amèrica/Mèxic (Ciutat)',
    ...
    'America/North_Dakota/Center' => 'Amèrica/North Dakota (Centre)',
    ...
    'America/St_Vincent' => 'Amèrica/Saint Vincent',
    ...
    'Asia/Yerevan' => 'Àsia/Erevan',
    'Atlantic/Azores' => 'Atlàntic/Azores',
    'Atlantic/Bermuda' => 'Atlàntic/Bermudes',
    'Atlantic/Canary' => 'Atlàntic/Canàries',
    'Atlantic/Cape_Verde' => 'Atlàntic/Cap Verd',
    'Atlantic/Faeroe' => 'Atlàntic/Fèroe',
    'Atlantic/Madeira' => 'Atlàntic/Madeira',
    'Atlantic/Reykjavik' => 'Atlàntic/Reykjavik',
    'Atlantic/South_Georgia' => 'Atlàntic/Geòrgia del Sud',
    'Atlantic/St_Helena' => 'Atlàntic/Santa Helena',
    ...
    'CET' => 'Europa/CET (Horari d\'Europa Central)',
    'EET' => 'Europa/EET (Horari d\'Europa de l\'Est)',
    'MET' => 'Europa/MET (Horari d\'Europa Mitjana)',
    'WET' => 'Europa/WET (Horari d\'Europa Occidental)',
    ...
    'Pacific/Galapagos' => 'Pacífic/Galápagos',
