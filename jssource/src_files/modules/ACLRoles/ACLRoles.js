...
var aclviewer = function () {
  ...
  return {
    ...
    save: function (form_name) {
      ...
      aclviewer.showMessageACLRoles(SUGAR.language.get("app_strings", "LBL_SAVING")+"...");
      // END STIC-Custom
    },
    postSave: function (o) {
      ...
      // STIC-Custom AAM 20260204 - showStatus not working properly with async calls
      aclviewer.hideMessageACLRoles();
      aclviewer.showMessageACLRoles(SUGAR.language.get("app_strings", "LBL_REQUEST_PROCESSED"));
      setTimeout(() => {
        aclviewer.hideMessageACLRoles();
      }, 2000); 
      // END STIC-Custom
